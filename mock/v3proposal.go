...
// V3Proposal fetches a blinded proposal for signing.
func (s *Service) V3Proposal(_ context.Context,
	...
	*api.Response[*api.VersionedV3Proposal],
	...
	versionedProposal := &api.VersionedV3Proposal{
		Version:          spec.DataVersionPhase0,
		BlindedBellatrix: blindedBlock,
	}

	metadata := make(map[string]any)
	metadata["Eth-Execution-Payload-Blinded"] = true

	return &api.Response[*api.VersionedV3Proposal]{
