...
func (s *Service) BeaconAttesterDomain(ctx context.Context) (spec.DomainType, error) {
	...
	// Beacon attester domain is static so no need to worry about failover.
	return s.activeClients[0].(eth2client.BeaconAttesterDomainProvider).BeaconAttesterDomain(ctx)
}
