...
func (s *Service) SelectionProofDomain(ctx context.Context) (spec.DomainType, error) {
	...
	// Selection proof domain is static so no need to worry about failover.
	return s.activeClients[0].(eth2client.SelectionProofDomainProvider).SelectionProofDomain(ctx)
}
