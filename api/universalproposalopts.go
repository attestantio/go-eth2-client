...
// UniversalProposalOpts are the options for obtaining universal proposals.
type UniversalProposalOpts struct {
	Common CommonOpts
	...
	// BuilderBoostFactor is percentage multiplier to apply to the builder's payload value when
	// choosing between a builder payload header and payload from the paired execution node.
