...
// Hash: 1419db639a27ffc7ada42c4be3d4664ebefcfac2dde8d053e587265e5c1d8614
...
func (t *SignedBlockContents) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *deneb.SignedBeaconBlock) (err error) { // *deneb.SignedBeaconBlock
	...
	fn4 := func(t *SignedBlockContents) (err error) { // *deneb.SignedBlockContents
		dstlen := len(dst)
...
func (t *SignedBlockContents) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	sfn1 := func(t *deneb.SignedBeaconBlock) (size int) { // *deneb.SignedBeaconBlock
...
func (t *SignedBlockContents) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	fn1 := func(t *deneb.SignedBeaconBlock, buf []byte) (*deneb.SignedBeaconBlock, error) { // *deneb.SignedBeaconBlock
		var err error
		if t == nil {
