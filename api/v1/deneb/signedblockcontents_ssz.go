...
// Hash: 13856d5b2da8ed3b8a54cd0eff6c1856c0fb9b26b0d2f3a64fb221ea95e1f538
...
func (t *SignedBlockContents) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn22 := func(t *deneb.SignedBeaconBlock) (err error) { // *deneb.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
	...
	fn23 := func(t []deneb.KZGProof) (err error) { // []deneb.KZGProof:48
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			dst = append(dst, t[i][:]...)
		}
	...
	fn24 := func(t []deneb.Blob) (err error) { // []deneb.Blob:131072
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			dst = append(dst, t[i][:]...)
		}
	...
	fn25 := func(t *SignedBlockContents) (err error) { // *deneb.SignedBlockContents
		dstlen := len(dst)
...
func (t *SignedBlockContents) SizeSSZ() (size int) {
	...
	sfn17 := func(t *deneb.SignedBeaconBlock) (size int) { // *deneb.SignedBeaconBlock
		size = 96
		size += 4 + sfn16(t.Message)
		return size
	}
	sfn18 := func(t []deneb.KZGProof) (size int) { // []deneb.KZGProof:48
		size += len(t) * 48
		return size
	}
	sfn19 := func(t []deneb.Blob) (size int) { // []deneb.Blob:131072
		size += len(t) * 131072
		return size
	}
	sfn20 := func(t *SignedBlockContents) (size int) { // *SignedBlockContents
		size = 0
		size += 4 + sfn17(t.SignedBlock)
		size += 4 + sfn18(t.KZGProofs)
		size += 4 + sfn19(t.Blobs)
		return size
	}
	return sfn20(t)
}
...
func (t *SignedBlockContents) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn21 := func(t *deneb.BeaconBlock, buf []byte) (*deneb.BeaconBlock, error) { // *deneb.BeaconBlock
		var err error
		if t == nil {
	...
	fn22 := func(t *deneb.SignedBeaconBlock, buf []byte) (*deneb.SignedBeaconBlock, error) { // *deneb.SignedBeaconBlock
		var err error
		if t == nil {
	...
	fn23 := func(t []deneb.KZGProof, buf []byte) ([]deneb.KZGProof, error) { // []deneb.KZGProof:48
		var err error
		buflen := len(buf)
		itemsize := 48
		itemCount := buflen / itemsize
	...
	fn24 := func(t []deneb.Blob, buf []byte) ([]deneb.Blob, error) { // []deneb.Blob:131072
		var err error
		buflen := len(buf)
		itemsize := 131072
		itemCount := buflen / itemsize
	...
	fn25 := func(t *SignedBlockContents, buf []byte) (*SignedBlockContents, error) { // *SignedBlockContents
		var err error
		if t == nil {
		...
		}
		{
			...
			if t.SignedBlock, err = fn22(t.SignedBlock, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.KZGProofs, err = fn23(t.KZGProofs, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.Blobs, err = fn24(t.Blobs, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
...
func (t *SignedBlockContents) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn19 := func(t []deneb.KZGCommitment) (err error) { // []deneb.KZGCommitment:4096:48
		maxLen := 4096
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn23 := func(t []deneb.KZGProof) (err error) { // []deneb.KZGProof:4096:48
		maxLen := 4096
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn24 := func(t []deneb.Blob) (err error) { // []deneb.Blob:4096:131072
		maxLen := 4096
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
