...
// Hash: 098581780f37b572ea7e256d6098ab709bd8f751e5be069d6d494763bf41a928
...
func (t *BlockContents) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn22 := func(t []deneb.KZGProof) (err error) { // []deneb.KZGProof:48
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			dst = append(dst, t[i][:]...)
		}
	...
	fn23 := func(t []deneb.Blob) (err error) { // []deneb.Blob:131072
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			dst = append(dst, t[i][:]...)
		}
...
func (t *BlockContents) SizeSSZ() (size int) {
	...
	sfn17 := func(t []deneb.KZGProof) (size int) { // []deneb.KZGProof:48
		size += len(t) * 48
		return size
	}
	sfn18 := func(t []deneb.Blob) (size int) { // []deneb.Blob:131072
		size += len(t) * 131072
		return size
	}
	sfn19 := func(t *BlockContents) (size int) { // *BlockContents
		size = 0
		size += 4 + sfn16(t.Block)
		size += 4 + sfn17(t.KZGProofs)
		size += 4 + sfn18(t.Blobs)
		return size
	}
	return sfn19(t)
}
...
func (t *BlockContents) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn22 := func(t []deneb.KZGProof, buf []byte) ([]deneb.KZGProof, error) { // []deneb.KZGProof:48
		var err error
		buflen := len(buf)
		itemsize := 48
		itemCount := buflen / itemsize
	...
	fn23 := func(t []deneb.Blob, buf []byte) ([]deneb.Blob, error) { // []deneb.Blob:131072
		var err error
		buflen := len(buf)
		itemsize := 131072
		itemCount := buflen / itemsize
	...
	fn24 := func(t *BlockContents, buf []byte) (*BlockContents, error) { // *BlockContents
		var err error
		if t == nil {
			t = new(BlockContents)
		}
		...
		}
		{
			...
			if t.Block, err = fn21(t.Block, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.KZGProofs, err = fn22(t.KZGProofs, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.Blobs, err = fn23(t.Blobs, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
