...
// Hash: fd880d72595aa756699df96152b2b0bcda921dd951dc2728753f921cce2001df
...
func (t *BlindedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BlindedBeaconBlockBody) (err error) { // *deneb.BlindedBeaconBlockBody
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *BlindedBeaconBlock) (err error) { // *deneb.BlindedBeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
