...
// Hash: c62f3689379c36055f3dd625ed91c48b4442a6fb0e27cc6e07c2a22467d2561e
...
func (t *SignedBlindedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn20 := func(t *BlindedBeaconBlockBody) (err error) { // *deneb.BlindedBeaconBlockBody
		dstlen := len(dst)
	...
	fn21 := func(t *BlindedBeaconBlock) (err error) { // *deneb.BlindedBeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
	...
	fn22 := func(t *SignedBlindedBeaconBlock) (err error) { // *deneb.SignedBlindedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBlindedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn15 := func(t *BlindedBeaconBlockBody) (size int) { // *BlindedBeaconBlockBody
		size = 200
	...
	sfn16 := func(t *BlindedBeaconBlock) (size int) { // *BlindedBeaconBlock
		size = 80
		size += 4 + sfn15(t.Body)
		return size
	}
	sfn17 := func(t *SignedBlindedBeaconBlock) (size int) { // *SignedBlindedBeaconBlock
		size = 96
...
func (t *SignedBlindedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn20 := func(t *BlindedBeaconBlockBody, buf []byte) (*BlindedBeaconBlockBody, error) { // *BlindedBeaconBlockBody
		var err error
		if t == nil {
	...
	fn21 := func(t *BlindedBeaconBlock, buf []byte) (*BlindedBeaconBlock, error) { // *BlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn22 := func(t *SignedBlindedBeaconBlock, buf []byte) (*SignedBlindedBeaconBlock, error) { // *SignedBlindedBeaconBlock
		var err error
		if t == nil {
...
func (t *SignedBlindedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn12 := func(t []*capella.SignedBLSToExecutionChange) (err error) { // []*capella.SignedBLSToExecutionChange:16
		maxLen := 16
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn13 := func(t []deneb.KZGCommitment) (err error) { // []deneb.KZGCommitment:4096:48
		maxLen := 4096
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn14 := func(t *BlindedBeaconBlockBody) (err error) { // *deneb.BlindedBeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
		...
		if err = fn12(t.BLSToExecutionChanges); err != nil {
			return err
		}
		// Field #11 'BlobKZGCommitments'
		if err = fn13(t.BlobKZGCommitments); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
	}
	fn15 := func(t *BlindedBeaconBlock) (err error) { // *deneb.BlindedBeaconBlock
		idx := hh.Index()
		// Field #0 'Slot'
	...
	fn16 := func(t *SignedBlindedBeaconBlock) (err error) { // *deneb.SignedBlindedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
		if err = fn15(t.Message); err != nil {
			return err
		}
		// Field #1 'Signature'
		hh.PutBytes(t.Signature[:])
