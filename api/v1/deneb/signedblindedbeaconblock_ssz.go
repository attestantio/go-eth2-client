...
// Hash: 8728ec897478a7ee175255b2ab20082a3ca4b47e3170f37337765c0ed9e5d0ef
...
func (t *SignedBlindedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BlindedBeaconBlock) (err error) { // *deneb.BlindedBeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *SignedBlindedBeaconBlock) (err error) { // *deneb.SignedBlindedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
