...
func (t *SignedBlindedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn16 := func(t *bellatrix.ExecutionPayloadHeader) (err error) { // *bellatrix.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn17 := func(t *BlindedBeaconBlockBody) (err error) { // *bellatrix.BlindedBeaconBlockBody
		dstlen := len(dst)
	...
	fn18 := func(t *BlindedBeaconBlock) (err error) { // *bellatrix.BlindedBeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
	...
	fn19 := func(t *SignedBlindedBeaconBlock) (err error) { // *bellatrix.SignedBlindedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBlindedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn12 := func(t *bellatrix.ExecutionPayloadHeader) (size int) { // *bellatrix.ExecutionPayloadHeader
		size = t.SizeSSZ()
		return size
	}
	sfn13 := func(t *BlindedBeaconBlockBody) (size int) { // *BlindedBeaconBlockBody
		size = 200
	...
	sfn14 := func(t *BlindedBeaconBlock) (size int) { // *BlindedBeaconBlock
		size = 80
		size += 4 + sfn13(t.Body)
		return size
	}
	sfn15 := func(t *SignedBlindedBeaconBlock) (size int) { // *SignedBlindedBeaconBlock
		size = 96
...
func (t *SignedBlindedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn16 := func(t *bellatrix.ExecutionPayloadHeader, buf []byte) (*bellatrix.ExecutionPayloadHeader, error) { // *bellatrix.ExecutionPayloadHeader
		var err error
		if t == nil {
	...
	fn17 := func(t *BlindedBeaconBlockBody, buf []byte) (*BlindedBeaconBlockBody, error) { // *BlindedBeaconBlockBody
		var err error
		if t == nil {
	...
	fn18 := func(t *BlindedBeaconBlock, buf []byte) (*BlindedBeaconBlock, error) { // *BlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn19 := func(t *SignedBlindedBeaconBlock, buf []byte) (*SignedBlindedBeaconBlock, error) { // *SignedBlindedBeaconBlock
		var err error
		if t == nil {
...
func (t *SignedBlindedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn12 := func(t *BlindedBeaconBlockBody) (err error) { // *bellatrix.BlindedBeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
	...
	fn13 := func(t *BlindedBeaconBlock) (err error) { // *bellatrix.BlindedBeaconBlock
		idx := hh.Index()
		// Field #0 'Slot'
	...
	fn14 := func(t *SignedBlindedBeaconBlock) (err error) { // *bellatrix.SignedBlindedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
