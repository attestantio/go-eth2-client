...
// Hash: baaed062988f7535730b401bb2d1af1077c602b25ddc146cf2c4dfb1330af8ad
...
func (t *SignedBlindedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BlindedBeaconBlock) (err error) { // *bellatrix.BlindedBeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *SignedBlindedBeaconBlock) (err error) { // *bellatrix.SignedBlindedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
...
func (t *SignedBlindedBeaconBlock) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	sfn1 := func(t *BlindedBeaconBlock) (size int) { // *BlindedBeaconBlock
		size = t.SizeSSZDyn(ds)
		return size
	}
	sfn2 := func(t *SignedBlindedBeaconBlock) (size int) { // *SignedBlindedBeaconBlock
		size = 96
...
func (t *SignedBlindedBeaconBlock) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	fn1 := func(t *BlindedBeaconBlock, buf []byte) (*BlindedBeaconBlock, error) { // *BlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn2 := func(t *SignedBlindedBeaconBlock, buf []byte) (*SignedBlindedBeaconBlock, error) { // *SignedBlindedBeaconBlock
		var err error
		if t == nil {
...
func (t *SignedBlindedBeaconBlock) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	fn1 := func(t *BlindedBeaconBlock) (err error) { // *bellatrix.BlindedBeaconBlock
...
func (t *SignedBlindedBeaconBlock) HashTreeRootDyn(ds sszutils.DynamicSpecs) ([32]byte, error) {
