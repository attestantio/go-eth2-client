...
// Hash: 4d9fbf2c04f4ac660ed668ea2fafe7187fee9549f7c2661a057b5604137914eb
...
func (t *BlindedBeaconBlockBody) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn13 := func(t *bellatrix.ExecutionPayloadHeader) (err error) { // *bellatrix.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn14 := func(t *BlindedBeaconBlockBody) (err error) { // *bellatrix.BlindedBeaconBlockBody
		dstlen := len(dst)
...
func (t *BlindedBeaconBlockBody) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn10 := func(t *bellatrix.ExecutionPayloadHeader) (size int) { // *bellatrix.ExecutionPayloadHeader
		size = t.SizeSSZ()
		return size
	}
	sfn11 := func(t *BlindedBeaconBlockBody) (size int) { // *BlindedBeaconBlockBody
		size = 200
...
func (t *BlindedBeaconBlockBody) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	fn13 := func(t *bellatrix.ExecutionPayloadHeader, buf []byte) (*bellatrix.ExecutionPayloadHeader, error) { // *bellatrix.ExecutionPayloadHeader
		var err error
		if t == nil {
	...
	fn14 := func(t *BlindedBeaconBlockBody, buf []byte) (*BlindedBeaconBlockBody, error) { // *BlindedBeaconBlockBody
		var err error
		if t == nil {
