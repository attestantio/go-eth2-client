...
// Hash: ae654ddced78005fca0dd998b31e9a5edb7380005c4b738257bc17a08a6a208c
...
func (t *BlindedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BlindedBeaconBlockBody) (err error) { // *bellatrix.BlindedBeaconBlockBody
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *BlindedBeaconBlock) (err error) { // *bellatrix.BlindedBeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
