...
func main() {
	...
	generator.BuildFile(
		...
		codegen.WithReflectType(reflect.TypeOf(&capella.BlindedBeaconBlock{})),
		codegen.WithoutDynamicExpressions(),
		codegen.WithCreateLegacyFn(),
	)
	generator.BuildFile(
		filepath.Join(parentDir, "blindedbeaconblockbody_ssz.go"),
		codegen.WithReflectType(reflect.TypeOf(&capella.BlindedBeaconBlockBody{})),
		codegen.WithoutDynamicExpressions(),
		codegen.WithCreateLegacyFn(),
	)
	generator.BuildFile(
		filepath.Join(parentDir, "signedblindedbeaconblock_ssz.go"),
		codegen.WithReflectType(reflect.TypeOf(&capella.SignedBlindedBeaconBlock{})),
		codegen.WithoutDynamicExpressions(),
		codegen.WithCreateLegacyFn(),
	)
