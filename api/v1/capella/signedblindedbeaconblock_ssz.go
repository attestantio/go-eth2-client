...
// Hash: 005f1cd553b5d8f76deceda35d5f24e031ba3ec269c53ff2c569109d7e11f2f6
...
func (t *SignedBlindedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn16 := func(t *capella.ExecutionPayloadHeader) (err error) { // *capella.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn19 := func(t *BlindedBeaconBlockBody) (err error) { // *capella.BlindedBeaconBlockBody
		dstlen := len(dst)
	...
	fn20 := func(t *BlindedBeaconBlock) (err error) { // *capella.BlindedBeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
	...
	fn21 := func(t *SignedBlindedBeaconBlock) (err error) { // *capella.SignedBlindedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBlindedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn12 := func(t *capella.ExecutionPayloadHeader) (size int) { // *capella.ExecutionPayloadHeader
		size = t.SizeSSZ()
		return size
	}
	...
	sfn15 := func(t *BlindedBeaconBlock) (size int) { // *BlindedBeaconBlock
		size = 80
		size += 4 + sfn14(t.Body)
		return size
	}
	sfn16 := func(t *SignedBlindedBeaconBlock) (size int) { // *SignedBlindedBeaconBlock
		size = 96
...
func (t *SignedBlindedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn16 := func(t *capella.ExecutionPayloadHeader, buf []byte) (*capella.ExecutionPayloadHeader, error) { // *capella.ExecutionPayloadHeader
		var err error
		if t == nil {
	...
	fn19 := func(t *BlindedBeaconBlockBody, buf []byte) (*BlindedBeaconBlockBody, error) { // *BlindedBeaconBlockBody
		var err error
		if t == nil {
	...
	fn20 := func(t *BlindedBeaconBlock, buf []byte) (*BlindedBeaconBlock, error) { // *BlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn21 := func(t *SignedBlindedBeaconBlock, buf []byte) (*SignedBlindedBeaconBlock, error) { // *SignedBlindedBeaconBlock
		var err error
		if t == nil {
...
func (t *SignedBlindedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn13 := func(t *BlindedBeaconBlockBody) (err error) { // *capella.BlindedBeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
	...
	fn14 := func(t *BlindedBeaconBlock) (err error) { // *capella.BlindedBeaconBlock
		idx := hh.Index()
		// Field #0 'Slot'
		...
		// Field #4 'Body'
		if err = fn13(t.Body); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
	}
	fn15 := func(t *SignedBlindedBeaconBlock) (err error) { // *capella.SignedBlindedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
		if err = fn14(t.Message); err != nil {
			return err
		}
		// Field #1 'Signature'
		hh.PutBytes(t.Signature[:])
