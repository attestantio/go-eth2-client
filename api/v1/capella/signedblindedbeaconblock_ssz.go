...
// Hash: d0fc5f084f6948c6240281afb67e84edd35fb494a8b0e7926def6c65d1285376
...
func (t *SignedBlindedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BlindedBeaconBlock) (err error) { // *capella.BlindedBeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *SignedBlindedBeaconBlock) (err error) { // *capella.SignedBlindedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
