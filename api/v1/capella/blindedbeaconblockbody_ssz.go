...
// Hash: 865c644cd94a52fcf8520b5b80c1120e7e10c91a037929c2b5c54b07daf467dc
...
func (t *BlindedBeaconBlockBody) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn13 := func(t *capella.ExecutionPayloadHeader) (err error) { // *capella.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn16 := func(t *BlindedBeaconBlockBody) (err error) { // *capella.BlindedBeaconBlockBody
		dstlen := len(dst)
...
func (t *BlindedBeaconBlockBody) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn10 := func(t *capella.ExecutionPayloadHeader) (size int) { // *capella.ExecutionPayloadHeader
		size = t.SizeSSZ()
		return size
	}
	...
	sfn12 := func(t *BlindedBeaconBlockBody) (size int) { // *BlindedBeaconBlockBody
		size = 200
...
func (t *BlindedBeaconBlockBody) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	fn13 := func(t *capella.ExecutionPayloadHeader, buf []byte) (*capella.ExecutionPayloadHeader, error) { // *capella.ExecutionPayloadHeader
		var err error
		if t == nil {
	...
	fn16 := func(t *BlindedBeaconBlockBody, buf []byte) (*BlindedBeaconBlockBody, error) { // *BlindedBeaconBlockBody
		var err error
		if t == nil {
