...
// Hash: 5aad075c52046094be5b7b7ef86c80cb3e2459e16ee07d6e98a1d5da9933aa38
...
func (t *BlindedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BlindedBeaconBlockBody) (err error) { // *capella.BlindedBeaconBlockBody
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *BlindedBeaconBlock) (err error) { // *capella.BlindedBeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
