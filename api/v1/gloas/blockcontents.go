...
// BlockContents is the block-production response body for a self-built Gloas
// block: the beacon block together with the execution payload envelope, blobs
// and KZG proofs that the caller needs to publish it.
