...
type blockContentsYAML struct {
	Block                    *gloas.BeaconBlock              `yaml:"block"`
	ExecutionPayloadEnvelope *gloas.ExecutionPayloadEnvelope `yaml:"execution_payload_envelope"`
...
func (b *BlockContents) MarshalYAML() ([]byte, error) {
	yamlBytes, err := yaml.MarshalWithOptions(&blockContentsYAML{
		Block:                    b.Block,
		ExecutionPayloadEnvelope: b.ExecutionPayloadEnvelope,
