...
// SignedExecutionPayloadEnvelopeContents is the stateless request body for
// publishing an execution payload envelope: the signed envelope together with
// the blobs and KZG cell proofs the beacon node needs to build data column
// sidecars when it has none cached from its own block production.
