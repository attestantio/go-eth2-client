...
// Hash: a7bd3e0ab6d9811cd28f0116db4c77cc95d2c2179f2f56d350cf1e1903edc70e
...
var _ = sszutils.Annotate[SignedValidatorRegistration](`ssz-static:"true"`)
...
func (t *SignedValidatorRegistration) UnmarshalSSZ(buf []byte) (err error) {
	...
	if 180 != buflen {
		...
		return sszutils.ErrTrailingDataFn(buflen - 180)
	}
