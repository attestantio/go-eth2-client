...
// Hash: 88c4165bcead574da056da0c4c1988cadb5c5cae2156bb346ced0d8835be6c4d
...
func (t *SignedBlockContents) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *electra.SignedBeaconBlock) (err error) { // *electra.SignedBeaconBlock
	...
	fn4 := func(t *SignedBlockContents) (err error) { // *electra.SignedBlockContents
		dstlen := len(dst)
		...
		if err = fn1(t.SignedBlock); err != nil {
			return err
		}
...
func (t *SignedBlockContents) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	sfn1 := func(t *electra.SignedBeaconBlock) (size int) { // *electra.SignedBeaconBlock
	...
	sfn4 := func(t *SignedBlockContents) (size int) { // *SignedBlockContents
		size = 0
		size += 4 + sfn1(t.SignedBlock)
...
func (t *SignedBlockContents) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	fn1 := func(t *electra.SignedBeaconBlock, buf []byte) (*electra.SignedBeaconBlock, error) { // *electra.SignedBeaconBlock
		var err error
		if t == nil {
	...
	fn4 := func(t *SignedBlockContents, buf []byte) (*SignedBlockContents, error) { // *SignedBlockContents
		var err error
		if t == nil {
		...
		}
		{
			...
			if t.SignedBlock, err = fn1(t.SignedBlock, fieldSlice); err != nil {
				return t, err
			}
...
func (t *SignedBlockContents) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn31 := func(t []deneb.KZGProof) (err error) { // []deneb.KZGProof:4096:48
		maxLen := 4096
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn33 := func(t *SignedBlockContents) (err error) { // *electra.SignedBlockContents
		idx := hh.Index()
		// Field #0 'SignedBlock'
...
func (t *SignedBlockContents) HashTreeRootDyn(ds sszutils.DynamicSpecs) ([32]byte, error) {
