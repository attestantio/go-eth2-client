...
// Hash: 8fb68f9c1349da78bb6b66eb8f47fd901e19b4d7d62be35bf69772f2a38d990a
...
func (t *SignedBlindedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn19 := func(t *deneb.ExecutionPayloadHeader) (err error) { // *deneb.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn24 := func(t *BlindedBeaconBlockBody) (err error) { // *electra.BlindedBeaconBlockBody
		dstlen := len(dst)
	...
	fn25 := func(t *BlindedBeaconBlock) (err error) { // *electra.BlindedBeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
	...
	fn26 := func(t *SignedBlindedBeaconBlock) (err error) { // *electra.SignedBlindedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBlindedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn14 := func(t *deneb.ExecutionPayloadHeader) (size int) { // *deneb.ExecutionPayloadHeader
		size = t.SizeSSZ()
		return size
	}
	...
	sfn18 := func(t *BlindedBeaconBlockBody) (size int) { // *BlindedBeaconBlockBody
		size = 200
		...
		size += 4 + sfn14(t.ExecutionPayloadHeader)
		size += 4 + sfn15(t.BLSToExecutionChanges)
		size += 4 + sfn16(t.BlobKZGCommitments)
		size += 4 + sfn17(t.ExecutionRequests)
		return size
	}
	sfn19 := func(t *BlindedBeaconBlock) (size int) { // *BlindedBeaconBlock
		size = 80
		size += 4 + sfn18(t.Body)
		return size
	}
	sfn20 := func(t *SignedBlindedBeaconBlock) (size int) { // *SignedBlindedBeaconBlock
		size = 96
...
func (t *SignedBlindedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn19 := func(t *deneb.ExecutionPayloadHeader, buf []byte) (*deneb.ExecutionPayloadHeader, error) { // *deneb.ExecutionPayloadHeader
		var err error
		if t == nil {
	...
	fn24 := func(t *BlindedBeaconBlockBody, buf []byte) (*BlindedBeaconBlockBody, error) { // *BlindedBeaconBlockBody
		var err error
		if t == nil {
	...
	fn25 := func(t *BlindedBeaconBlock, buf []byte) (*BlindedBeaconBlock, error) { // *BlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn26 := func(t *SignedBlindedBeaconBlock, buf []byte) (*SignedBlindedBeaconBlock, error) { // *SignedBlindedBeaconBlock
		var err error
		if t == nil {
...
func (t *SignedBlindedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn18 := func(t []*electra.DepositRequest) (err error) { // []*electra.DepositRequest:8192
		maxLen := 8192
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn19 := func(t []*electra.WithdrawalRequest) (err error) { // []*electra.WithdrawalRequest:16
		maxLen := 16
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn20 := func(t []*electra.ConsolidationRequest) (err error) { // []*electra.ConsolidationRequest:2
		maxLen := 2
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn23 := func(t *BlindedBeaconBlock) (err error) { // *electra.BlindedBeaconBlock
		idx := hh.Index()
		// Field #0 'Slot'
	...
	fn24 := func(t *SignedBlindedBeaconBlock) (err error) { // *electra.SignedBlindedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
		if err = fn23(t.Message); err != nil {
			return err
		}
		// Field #1 'Signature'
		hh.PutBytes(t.Signature[:])
