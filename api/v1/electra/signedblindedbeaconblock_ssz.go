...
// Hash: 625a7971b61c53f9a4c4cfa2cb3e8342bf328fc2b8644c71ec6f3dd305fa5624
...
func (t *SignedBlindedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BlindedBeaconBlock) (err error) { // *electra.BlindedBeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *SignedBlindedBeaconBlock) (err error) { // *electra.SignedBlindedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
