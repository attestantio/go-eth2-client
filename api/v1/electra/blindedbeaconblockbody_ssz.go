...
// Hash: 0f289f0e08b641f8eb056d6278c8aabee3a3439f6361ddac250be5c7fedd7cd8
...
func (t *BlindedBeaconBlockBody) UnmarshalSSZ(buf []byte) (err error) {
	...
	{ // Field #4 'AttesterSlashings' (dynamic)
		...
		if len(val2) < itemCount {
			val2 = make([]*electra.AttesterSlashing, itemCount)
	...
	{ // Field #5 'Attestations' (dynamic)
		...
		if len(val4) < itemCount {
			val4 = make([]*electra.Attestation, itemCount)
