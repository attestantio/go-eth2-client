...
// Hash: f3faf4a30c2163b9828ba4fecbb8b637f79a443988dc0267a1d529f96865cf33
...
func (t *BlockContents) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn26 := func(t []deneb.KZGProof) (err error) { // []deneb.KZGProof:48
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			dst = append(dst, t[i][:]...)
		}
	...
	fn27 := func(t []deneb.Blob) (err error) { // []deneb.Blob:131072
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			dst = append(dst, t[i][:]...)
		}
	...
	fn28 := func(t *BlockContents) (err error) { // *fulu.BlockContents
		dstlen := len(dst)
		// Offset #0 'Block'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *BlockContents) SizeSSZ() (size int) {
	...
	sfn20 := func(t []deneb.KZGProof) (size int) { // []deneb.KZGProof:48
		size += len(t) * 48
		return size
	}
	sfn21 := func(t []deneb.Blob) (size int) { // []deneb.Blob:131072
		size += len(t) * 131072
		return size
	}
	sfn22 := func(t *BlockContents) (size int) { // *BlockContents
		size = 0
		size += 4 + sfn19(t.Block)
		size += 4 + sfn20(t.KZGProofs)
		size += 4 + sfn21(t.Blobs)
		return size
	}
	return sfn22(t)
}
...
func (t *BlockContents) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn26 := func(t []deneb.KZGProof, buf []byte) ([]deneb.KZGProof, error) { // []deneb.KZGProof:48
		var err error
		buflen := len(buf)
		itemsize := 48
		itemCount := buflen / itemsize
	...
	fn27 := func(t []deneb.Blob, buf []byte) ([]deneb.Blob, error) { // []deneb.Blob:131072
		var err error
		buflen := len(buf)
		itemsize := 131072
		itemCount := buflen / itemsize
	...
	fn28 := func(t *BlockContents, buf []byte) (*BlockContents, error) { // *BlockContents
		var err error
		if t == nil {
			t = new(BlockContents)
		}
		...
		}
		{
			...
			if t.Block, err = fn25(t.Block, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.KZGProofs, err = fn26(t.KZGProofs, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.Blobs, err = fn27(t.Blobs, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
