...
// Hash: 3f749a8e8dc164d8339d47776bcc032cb394c95edeb518307a98a62f8680716c
...
func (t *BlockContents) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn4 := func(t *BlockContents) (err error) { // *fulu.BlockContents
		dstlen := len(dst)
		// Offset #0 'Block'
		offset0 := len(dst)
...
func (t *BlockContents) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn30 := func(t []deneb.KZGProof) (err error) { // []deneb.KZGProof:33554432:48
		maxLen := 33554432
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn32 := func(t *BlockContents) (err error) { // *fulu.BlockContents
		idx := hh.Index()
		// Field #0 'Block'
