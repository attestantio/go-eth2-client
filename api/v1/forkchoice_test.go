...
func TestForkChoiceNodeJSON(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			err:   "incorrect length 0 for parent root",
		},
		{
		...
		},
		{
			...
			err:   "invalid value for validity: NOT_A_VALID_VALIDITY: invalid value for fork choice node validity: NOT_A_VALID_VALIDITY",
		},
		{
