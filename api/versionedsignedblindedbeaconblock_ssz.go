...
// Hash: e75cb48f424115c9175d9cf65c831da2463b2ceb4eeaf2216fbe9e8d90c7dc94
...
func (t *VersionedSignedBlindedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *bellatrix.SignedBlindedBeaconBlock) (err error) { // *bellatrix.SignedBlindedBeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *capella.SignedBlindedBeaconBlock) (err error) { // *capella.SignedBlindedBeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn3 := func(t *deneb.SignedBlindedBeaconBlock) (err error) { // *deneb.SignedBlindedBeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn4 := func(t *electra.SignedBlindedBeaconBlock) (err error) { // *electra.SignedBlindedBeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn5 := func(t *VersionedSignedBlindedBeaconBlock) (err error) { // *api.VersionedSignedBlindedBeaconBlock
		dstlen := len(dst)
		// Field #0 'Version'
...
func (t *VersionedSignedBlindedBeaconBlock) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	sfn1 := func(t *bellatrix.SignedBlindedBeaconBlock) (size int) { // *bellatrix.SignedBlindedBeaconBlock
		size = t.SizeSSZDyn(ds)
		return size
	}
	sfn2 := func(t *capella.SignedBlindedBeaconBlock) (size int) { // *capella.SignedBlindedBeaconBlock
		size = t.SizeSSZDyn(ds)
		return size
	}
	sfn3 := func(t *deneb.SignedBlindedBeaconBlock) (size int) { // *deneb.SignedBlindedBeaconBlock
		size = t.SizeSSZDyn(ds)
		return size
	}
	sfn4 := func(t *electra.SignedBlindedBeaconBlock) (size int) { // *electra.SignedBlindedBeaconBlock
		size = t.SizeSSZDyn(ds)
		return size
	}
	sfn5 := func(t *VersionedSignedBlindedBeaconBlock) (size int) { // *VersionedSignedBlindedBeaconBlock
		size = 8
...
func (t *VersionedSignedBlindedBeaconBlock) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	fn1 := func(t *bellatrix.SignedBlindedBeaconBlock, buf []byte) (*bellatrix.SignedBlindedBeaconBlock, error) { // *bellatrix.SignedBlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn2 := func(t *capella.SignedBlindedBeaconBlock, buf []byte) (*capella.SignedBlindedBeaconBlock, error) { // *capella.SignedBlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn3 := func(t *deneb.SignedBlindedBeaconBlock, buf []byte) (*deneb.SignedBlindedBeaconBlock, error) { // *deneb.SignedBlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn4 := func(t *electra.SignedBlindedBeaconBlock, buf []byte) (*electra.SignedBlindedBeaconBlock, error) { // *electra.SignedBlindedBeaconBlock
		var err error
		if t == nil {
	...
	fn5 := func(t *VersionedSignedBlindedBeaconBlock, buf []byte) (*VersionedSignedBlindedBeaconBlock, error) { // *VersionedSignedBlindedBeaconBlock
		var err error
		if t == nil {
...
func (t *VersionedSignedBlindedBeaconBlock) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn23 := func(t []uint64) (err error) { // []uint64:131072:MAX_VALIDATORS_PER_COMMITTEE*MAX_COMMITTEES_PER_SLOT
	...
	fn27 := func(t go_bitfield.Bitlist) (err error) { // bitfield.Bitlist:131072:MAX_VALIDATORS_PER_COMMITTEE*MAX_COMMITTEES_PER_SLOT
		hasLimit, maxLen, err := ds.ResolveSpecValue("MAX_VALIDATORS_PER_COMMITTEE*MAX_COMMITTEES_PER_SLOT")
		if err != nil {
			return err
		}
	...
	fn28 := func(t go_bitfield.Bitvector64) (err error) { // bitfield.Bitvector64:8:MAX_COMMITTEES_PER_SLOT/8
	...
	fn31 := func(t []*electra1.DepositRequest) (err error) { // []*electra.DepositRequest:8192:MAX_DEPOSIT_REQUESTS_PER_PAYLOAD
	...
	fn32 := func(t []*electra1.WithdrawalRequest) (err error) { // []*electra.WithdrawalRequest:16:MAX_WITHDRAWAL_REQUESTS_PER_PAYLOAD
	...
	fn33 := func(t []*electra1.ConsolidationRequest) (err error) { // []*electra.ConsolidationRequest:2:MAX_CONSOLIDATION_REQUESTS_PER_PAYLOAD
...
func (t *VersionedSignedBlindedBeaconBlock) HashTreeRootDyn(ds sszutils.DynamicSpecs) ([32]byte, error) {
