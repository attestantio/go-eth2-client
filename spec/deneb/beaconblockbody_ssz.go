...
// Hash: 792b5a97333f88ad00bae1e218bc486ea0c53eaed3b37386bd965b6696e11235
...
func (t *BeaconBlockBody) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn13 := func(t *ExecutionPayload) (err error) { // *deneb.ExecutionPayload
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn16 := func(t []KZGCommitment) (err error) { // []deneb.KZGCommitment:48
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			dst = append(dst, t[i][:]...)
		}
	...
	fn17 := func(t *BeaconBlockBody) (err error) { // *deneb.BeaconBlockBody
		dstlen := len(dst)
...
func (t *BeaconBlockBody) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn12 := func(t []KZGCommitment) (size int) { // []KZGCommitment:48
		size += len(t) * 48
		return size
	}
...
func (t *BeaconBlockBody) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	fn16 := func(t []KZGCommitment, buf []byte) ([]KZGCommitment, error) { // []KZGCommitment:48
		var err error
		buflen := len(buf)
		itemsize := 48
		itemCount := buflen / itemsize
...
func (t *BeaconBlockBody) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn12 := func(t *ExecutionPayload) (err error) { // *deneb.ExecutionPayload
		err = t.HashTreeRootWithDyn(ds, hh)
		return err
	}
	fn13 := func(t []*capella.SignedBLSToExecutionChange) (err error) { // []*capella.SignedBLSToExecutionChange:16:MAX_BLS_TO_EXECUTION_CHANGES
	...
	fn14 := func(t []KZGCommitment) (err error) { // []deneb.KZGCommitment:4096:MAX_BLOB_COMMITMENTS_PER_BLOCK:48
	...
	fn15 := func(t *BeaconBlockBody) (err error) { // *deneb.BeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
		...
		if err = fn13(t.BLSToExecutionChanges); err != nil {
			return err
		}
		// Field #11 'BlobKZGCommitments'
		if err = fn14(t.BlobKZGCommitments); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
