...
// Hash: 85ace63cd240ab6d2d549afb575a125640cb1445867916776c6666b43896c5f0
...
func (t *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn17 := func(t *ExecutionPayloadHeader) (err error) { // *deneb.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn20 := func(t *BeaconState) (err error) { // *deneb.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn13 := func(t *BeaconState) (err error) { // *deneb.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
