...
// Hash: b6857f155a1f3d6d5bdcc223681b1ee1a3b60094a611a9711d94ae22bf8889e1
...
func (t *BeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BeaconBlockBody) (err error) { // *deneb.BeaconBlockBody
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *BeaconBlock) (err error) { // *deneb.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
