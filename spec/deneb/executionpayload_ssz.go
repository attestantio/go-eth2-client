...
// Hash: e138e99b3b01f64306f18f74f852916702218a9572a3e3ad15e93745bbbe36d2
...
func (t *ExecutionPayload) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn2 := func(t *uint256.Int) (err error) { // *uint256.Int:4
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn4 := func(t []bellatrix.Transaction) (err error) { // []bellatrix.Transaction
		vlen := len(t)
		dstlen := len(dst)
	...
	fn5 := func(t *capella.Withdrawal) (err error) { // *capella.Withdrawal
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn6 := func(t []*capella.Withdrawal) (err error) { // []*capella.Withdrawal
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn7 := func(t *ExecutionPayload) (err error) { // *deneb.ExecutionPayload
		dstlen := len(dst)
		// Field #0 'ParentHash'
		...
		if err = fn2(t.BaseFeePerGas); err != nil {
			return err
		}
		// Field #12 'BlockHash'
...
func (t *ExecutionPayload) SizeSSZ() (size int) {
	...
	sfn4 := func(t []*capella.Withdrawal) (size int) { // []*capella.Withdrawal
		size += len(t) * 44
		return size
	}
...
func (t *ExecutionPayload) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn2 := func(t *uint256.Int, buf []byte) (*uint256.Int, error) { // *uint256.Int:4
		var err error
		if t == nil {
			t = new(uint256.Int)
		}
	...
	fn4 := func(t []bellatrix.Transaction, buf []byte) ([]bellatrix.Transaction, error) { // []bellatrix.Transaction
		var err error
		buflen := len(buf)
		if buflen == 0 {
			return t, nil
		...
		for i := 0; i < itemCount; i++ {
			...
			if t[i], err = fn3(t[i], buf[offset:endOffset]); err != nil {
				return t, err
			}
			offset = endOffset
		}
	...
	fn5 := func(t *capella.Withdrawal, buf []byte) (*capella.Withdrawal, error) { // *capella.Withdrawal
		var err error
		if t == nil {
	...
	fn6 := func(t []*capella.Withdrawal, buf []byte) ([]*capella.Withdrawal, error) { // []*capella.Withdrawal
		var err error
		buflen := len(buf)
		itemsize := 44
	...
	fn7 := func(t *ExecutionPayload, buf []byte) (*ExecutionPayload, error) { // *ExecutionPayload
		var err error
		if t == nil {
		...
		// Field #11 'BaseFeePerGas'
		if t.BaseFeePerGas, err = fn2(t.BaseFeePerGas, buf[440:472]); err != nil {
			return t, err
		}
		// Field #12 'BlockHash'
		...
		}
		{
			...
			if t.Transactions, err = fn4(t.Transactions, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.Withdrawals, err = fn6(t.Withdrawals, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
...
func (t *ExecutionPayload) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn3 := func(t bellatrix.Transaction) (err error) { // bellatrix.Transaction:1073741824:MAX_BYTES_PER_TRANSACTION:pack
	...
	fn4 := func(t []bellatrix.Transaction) (err error) { // []bellatrix.Transaction:1048576:MAX_TRANSACTIONS_PER_PAYLOAD:MAX_BYTES_PER_TRANSACTION
	...
	fn5 := func(t []*capella.Withdrawal) (err error) { // []*capella.Withdrawal:16:MAX_WITHDRAWALS_PER_PAYLOAD
	...
	fn6 := func(t *ExecutionPayload) (err error) { // *deneb.ExecutionPayload
		idx := hh.Index()
		// Field #0 'ParentHash'
