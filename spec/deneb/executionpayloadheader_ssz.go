...
// Hash: 9ba295b9288d248b461f1b89679e35e7604572d2a114105c4fbbc0d10922c893
...
func (t *ExecutionPayloadHeader) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *uint256.Int) (err error) { // *uint256.Int:4
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn2 := func(t *ExecutionPayloadHeader) (err error) { // *deneb.ExecutionPayloadHeader
		dstlen := len(dst)
		// Field #0 'ParentHash'
		...
		if err = fn1(t.BaseFeePerGas); err != nil {
			return err
		}
		// Field #12 'BlockHash'
...
func (t *ExecutionPayloadHeader) UnmarshalSSZ(buf []byte) (err error) {
	fn1 := func(t *uint256.Int, buf []byte) (*uint256.Int, error) { // *uint256.Int:4
		var err error
		if t == nil {
			t = new(uint256.Int)
		}
	...
	fn2 := func(t *ExecutionPayloadHeader, buf []byte) (*ExecutionPayloadHeader, error) { // *ExecutionPayloadHeader
		var err error
		if t == nil {
		...
		// Field #11 'BaseFeePerGas'
		if t.BaseFeePerGas, err = fn1(t.BaseFeePerGas, buf[440:472]); err != nil {
			return t, err
		}
		// Field #12 'BlockHash'
...
func (t *ExecutionPayloadHeader) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn3 := func(t *ExecutionPayloadHeader) (err error) { // *deneb.ExecutionPayloadHeader
		idx := hh.Index()
		// Field #0 'ParentHash'
