...
type VersionedExecutionPayload struct {
	...
	Glaos     *deneb.ExecutionPayload
}

// IsEmpty returns true if there is no block.
func (v *VersionedExecutionPayload) IsEmpty() bool {
	return v.Version < DataVersionBellatrix || (v.Bellatrix == nil && v.Capella == nil && v.Deneb == nil && v.Electra == nil && v.Fulu == nil && v.Glaos == nil)
}
...
func (v *VersionedExecutionPayload) ParentHash() (phase0.Hash32, error) {
	...
	case DataVersionGlaos:
		if v.Glaos == nil {
			return phase0.Hash32{}, errors.New("no glaos execution payload")
		}

		return v.Glaos.ParentHash, nil
	default:
...
func (v *VersionedExecutionPayload) FeeRecipient() (bellatrix.ExecutionAddress, error) {
	...
	case DataVersionGlaos:
		if v.Glaos == nil {
			return bellatrix.ExecutionAddress{}, errors.New("no glaos execution payload")
		}

		return v.Glaos.FeeRecipient, nil
	default:
...
func (v *VersionedExecutionPayload) StateRoot() (phase0.Root, error) {
	...
	case DataVersionGlaos:
		if v.Glaos == nil {
			return phase0.Root{}, errors.New("no glaos execution payload")
		}
...
func (v *VersionedExecutionPayload) ReceiptsRoot() (phase0.Root, error) {
	...
	case DataVersionGlaos:
		...
		return v.Glaos.ReceiptsRoot, nil
	default:
		return phase0.Root{}, errors.New("unknown version")
	}
}
...
func (v *VersionedExecutionPayload) LogsBloom() ([256]byte, error) {
	...
	case DataVersionGlaos:
		if v.Glaos == nil {
			return [256]byte{}, errors.New("no glaos execution payload")
		}

		return v.Glaos.LogsBloom, nil
	default:
...
func (v *VersionedExecutionPayload) PrevRandao() ([32]byte, error) {
	...
	case DataVersionGlaos:
		if v.Glaos == nil {
			return [32]byte{}, errors.New("no glaos execution payload")
		}

		return v.Glaos.PrevRandao, nil
	default:
...
func (v *VersionedExecutionPayload) BlockNumber() (uint64, error) {
	...
	case DataVersionGlaos:
		if v.Glaos == nil {
			return 0, errors.New("no glaos execution payload")
		}

		return v.Glaos.BlockNumber, nil
	default:
...
func (v *VersionedExecutionPayload) ExtraData() ([]byte, error) {
	...
	case DataVersionGlaos:
		if v.Glaos == nil {
			return nil, errors.New("no glaos execution payload")
		}

		return v.Glaos.ExtraData, nil
	default:
...
func (v *VersionedExecutionPayload) BaseFeePerGas() (*uint256.Int, error) {
	...
	case DataVersionGlaos:
		...
		return v.Glaos.BaseFeePerGas, nil
	default:
		return nil, errors.New("unknown version")
	}
}
...
func (v *VersionedExecutionPayload) Transactions() ([]bellatrix.Transaction, error) {
	...
	case DataVersionGlaos:
		...
		return v.Glaos.Transactions, nil
	default:
		return nil, errors.New("unknown version")
	}
}
...
func (v *VersionedExecutionPayload) Withdrawals() ([]*capella.Withdrawal, error) {
	...
	case DataVersionGlaos:
		...
		return v.Glaos.Withdrawals, nil
	default:
		return nil, errors.New("unknown version")
	}
}
...
func (v *VersionedExecutionPayload) BlobGasUsed() (uint64, error) {
	...
	case DataVersionGlaos:
		...
		return v.Glaos.BlobGasUsed, nil
	default:
		return 0, errors.New("unknown version")
	}
}
...
func (v *VersionedExecutionPayload) ExcessBlobGas() (uint64, error) {
	...
	case DataVersionGlaos:
		...
		return v.Glaos.ExcessBlobGas, nil
	default:
		return 0, errors.New("unknown version")
	}
}
