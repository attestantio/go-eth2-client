...
func TestDataVersionMarshalJSON(t *testing.T) {
	tests := []struct {
		...
		{name: "Unknown", version: spec.DataVersionUnknown, expected: `"unknown"`},
		{name: "Phase0", version: spec.DataVersionPhase0, expected: `"phase0"`},
		{name: "Altair", version: spec.DataVersionAltair, expected: `"altair"`},
		{name: "Bellatrix", version: spec.DataVersionBellatrix, expected: `"bellatrix"`},
		{name: "Capella", version: spec.DataVersionCapella, expected: `"capella"`},
		{name: "Deneb", version: spec.DataVersionDeneb, expected: `"deneb"`},
		{name: "Electra", version: spec.DataVersionElectra, expected: `"electra"`},
		{name: "Fulu", version: spec.DataVersionFulu, expected: `"fulu"`},
		{name: "Gloas", version: spec.DataVersionGloas, expected: `"gloas"`},
		// A fork added to the enum but not to the string table lands here.
		{name: "PastLastVersion", version: spec.DataVersionGloas + 1, expected: `"unknown"`},
