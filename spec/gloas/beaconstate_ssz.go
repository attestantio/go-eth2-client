...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (39) 'LatestBlockHash'
	dst = append(dst, b.LatestBlockHash[:]...)

	// Field (40) 'LatestWithdrawalsRoot'
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (25) 'NextWithdrawalIndex'
	b.NextWithdrawalIndex = capella.WithdrawalIndex(ssz.UnmarshallUint64(buf[2736789:2736797]))

	// Field (26) 'NextWithdrawalValidatorIndex'
	b.NextWithdrawalValidatorIndex = phase0.ValidatorIndex(ssz.UnmarshallUint64(buf[2736797:2736805]))
	...
	// Field (29) 'DepositBalanceToConsume'
	b.DepositBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736817:2736825]))

	// Field (30) 'ExitBalanceToConsume'
	b.ExitBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736825:2736833]))

	// Field (31) 'EarliestExitEpoch'
	b.EarliestExitEpoch = phase0.Epoch(ssz.UnmarshallUint64(buf[2736833:2736841]))

	// Field (32) 'ConsolidationBalanceToConsume'
	b.ConsolidationBalanceToConsume = phase0.Gwei(ssz.UnmarshallUint64(buf[2736841:2736849]))

	// Field (33) 'EarliestConsolidationEpoch'
	b.EarliestConsolidationEpoch = phase0.Epoch(ssz.UnmarshallUint64(buf[2736849:2736857]))
	...
	for ii := 0; ii < 64; ii++ {
		b.ProposerLookahead[ii] = phase0.ValidatorIndex(ssz.UnmarshallUint64(buf[2736869:2737381][ii*8 : (ii+1)*8]))
	}

	// Field (38) 'ExecutionPayloadAvailability'
	if cap(b.ExecutionPayloadAvailability) == 0 {
		b.ExecutionPayloadAvailability = make([]byte, 0, len(buf[2737381:2738405]))
	}
	b.ExecutionPayloadAvailability = append(b.ExecutionPayloadAvailability, buf[2737381:2738405]...)

	// Field (39) 'LatestBlockHash'
	copy(b.LatestBlockHash[:], buf[2738405:2738437])

	// Field (40) 'LatestWithdrawalsRoot'
	copy(b.LatestWithdrawalsRoot[:], buf[2738437:2738469])
