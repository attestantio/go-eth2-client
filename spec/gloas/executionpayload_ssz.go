...
// Hash: 81e5a47d626f6521c02c01a2b484460fd986437545dc852251014056c19596d0
...
func (t *ExecutionPayload) UnmarshalSSZ(buf []byte) (err error) {
	...
	{ // Field #17 'BlockAccessList' (dynamic)
		buf := buf[offset17:]
		val5 := t.BlockAccessList
		val5 = sszutils.ExpandSlice(val5, len(buf))
		copy(val5[:], buf)
		t.BlockAccessList = val5
	}
	return nil
}
...
func (t *ExecutionPayload) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	hh.MerkleizeProgressiveWithActiveFields(idx, []byte{0xff, 0xff, 0x07})
	return nil
}
