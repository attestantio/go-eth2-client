...
// Hash: fe82affff2713591f271d81296948125d5578e68a76e170a32ba09b065366ee0
...
func (t *BeaconState) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn16 := func(t *deneb.ExecutionPayloadHeader) (err error) { // *deneb.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn19 := func(t *electra.PendingDeposit) (err error) { // *electra.PendingDeposit
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn21 := func(t *electra.PendingPartialWithdrawal) (err error) { // *electra.PendingPartialWithdrawal
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn23 := func(t *electra.PendingConsolidation) (err error) { // *electra.PendingConsolidation
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn24 := func(t []*electra.PendingConsolidation) (err error) { // []*electra.PendingConsolidation
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			if err = fn23(t[i]); err != nil {
				return err
			}
		}
		return err
	}
	fn25 := func(t []phase0.ValidatorIndex) (err error) { // []phase0.ValidatorIndex:64:(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH
		hasLimit, limit, err := ds.ResolveSpecValue("(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH")
		if err != nil {
			return err
		}
		if !hasLimit {
	...
	fn26 := func(t *BeaconState) (err error) { // *fulu.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
		...
		if err = fn25(t.ProposerLookahead); err != nil {
			return err
		}
...
func (t *BeaconState) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn11 := func(t *deneb.ExecutionPayloadHeader) (size int) { // *deneb.ExecutionPayloadHeader
		size = t.SizeSSZ()
		return size
	}
	...
	sfn13 := func(t []*electra.PendingDeposit) (size int) { // []*electra.PendingDeposit
		size += len(t) * 192
		return size
	}
	sfn14 := func(t []*electra.PendingPartialWithdrawal) (size int) { // []*electra.PendingPartialWithdrawal
		size += len(t) * 24
		return size
	}
	sfn15 := func(t []*electra.PendingConsolidation) (size int) { // []*electra.PendingConsolidation
		size += len(t) * 16
		return size
	}
	sfn16 := func(t []phase0.ValidatorIndex) (size int) { // []phase0.ValidatorIndex:64:(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH
		hasLimit, limit, _ := ds.ResolveSpecValue("(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH")
		if !hasLimit {
			limit = 64
		}
		size += int(limit) * 8
	...
	sfn17 := func(t *BeaconState) (size int) { // *BeaconState
		...
		size += 4 + sfn13(t.PendingDeposits)
		size += 4 + sfn14(t.PendingPartialWithdrawals)
		size += 4 + sfn15(t.PendingConsolidations)
		size += sfn16(t.ProposerLookahead)
		return size
	}
	return sfn17(t)
}
...
func (t *BeaconState) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	sfn6 := func() (size int) { // []phase0.ValidatorIndex:64:(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH
		hasLimit, limit, _ := ds.ResolveSpecValue("(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH")
		if !hasLimit {
			limit = 64
		}
	...
	fn16 := func(t *deneb.ExecutionPayloadHeader, buf []byte) (*deneb.ExecutionPayloadHeader, error) { // *deneb.ExecutionPayloadHeader
		var err error
		if t == nil {
	...
	fn19 := func(t *electra.PendingDeposit, buf []byte) (*electra.PendingDeposit, error) { // *electra.PendingDeposit
		var err error
		if t == nil {
	...
	fn21 := func(t *electra.PendingPartialWithdrawal, buf []byte) (*electra.PendingPartialWithdrawal, error) { // *electra.PendingPartialWithdrawal
		var err error
		if t == nil {
	...
	fn23 := func(t *electra.PendingConsolidation, buf []byte) (*electra.PendingConsolidation, error) { // *electra.PendingConsolidation
		var err error
		if t == nil {
	...
	fn24 := func(t []*electra.PendingConsolidation, buf []byte) ([]*electra.PendingConsolidation, error) { // []*electra.PendingConsolidation
		...
		for i := 0; i < itemCount; i++ {
			if t[i], err = fn23(t[i], buf[i*itemsize:(i+1)*itemsize]); err != nil {
				return t, err
			}
		}
		return t, err
	}
	fn25 := func(t []phase0.ValidatorIndex, buf []byte) ([]phase0.ValidatorIndex, error) { // []phase0.ValidatorIndex:64:(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH
		var err error
		itemsize := 8
		limit := sfn6 / itemsize
		if len(t) < int(limit) {
	...
	fn26 := func(t *BeaconState, buf []byte) (*BeaconState, error) { // *BeaconState
		...
		{
			fieldsize := 8
			t.DepositRequestsStartIndex = (uint64)(sszutils.UnmarshallUint64(buf[bufpos : bufpos+fieldsize]))
			bufpos += fieldsize
		}
		// Field #29 'DepositBalanceToConsume'
		{
			fieldsize := 8
			t.DepositBalanceToConsume = (phase0.Gwei)(sszutils.UnmarshallUint64(buf[bufpos : bufpos+fieldsize]))
			bufpos += fieldsize
		}
		// Field #30 'ExitBalanceToConsume'
		{
			fieldsize := 8
			t.ExitBalanceToConsume = (phase0.Gwei)(sszutils.UnmarshallUint64(buf[bufpos : bufpos+fieldsize]))
			bufpos += fieldsize
		}
		// Field #31 'EarliestExitEpoch'
		{
			fieldsize := 8
			t.EarliestExitEpoch = (phase0.Epoch)(sszutils.UnmarshallUint64(buf[bufpos : bufpos+fieldsize]))
			bufpos += fieldsize
		}
		// Field #32 'ConsolidationBalanceToConsume'
		{
			fieldsize := 8
			t.ConsolidationBalanceToConsume = (phase0.Gwei)(sszutils.UnmarshallUint64(buf[bufpos : bufpos+fieldsize]))
			bufpos += fieldsize
		}
		// Field #33 'EarliestConsolidationEpoch'
		{
			fieldsize := 8
			t.EarliestConsolidationEpoch = (phase0.Epoch)(sszutils.UnmarshallUint64(buf[bufpos : bufpos+fieldsize]))
			bufpos += fieldsize
		}
		// Offset #34 'PendingDeposits'
		offset34 := int(sszutils.ReadOffset(buf[bufpos : bufpos+4]))
		bufpos += 4
		// Offset #35 'PendingPartialWithdrawals'
		offset35 := int(sszutils.ReadOffset(buf[bufpos : bufpos+4]))
		bufpos += 4
		// Offset #36 'PendingConsolidations'
		offset36 := int(sszutils.ReadOffset(buf[bufpos : bufpos+4]))
		bufpos += 4
		// Field #37 'ProposerLookahead'
		{
			fieldsize := sfn6
			...
			if t.ProposerLookahead, err = fn25(t.ProposerLookahead, buf[bufpos:bufpos+fieldsize]); err != nil {
				return t, err
			}
			bufpos += fieldsize
		}
		...
		}
		{
			...
			if t.PendingDeposits, err = fn20(t.PendingDeposits, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.PendingPartialWithdrawals, err = fn22(t.PendingPartialWithdrawals, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
		...
		}
		{
			...
			if t.PendingConsolidations, err = fn24(t.PendingConsolidations, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
...
func (t *BeaconState) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn12 := func(t []*capella.HistoricalSummary) (err error) { // []*capella.HistoricalSummary:16777216:HISTORICAL_ROOTS_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("HISTORICAL_ROOTS_LIMIT")
		if err != nil {
			return err
		}
	...
	fn13 := func(t []*electra.PendingDeposit) (err error) { // []*electra.PendingDeposit:134217728:PENDING_DEPOSITS_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("PENDING_DEPOSITS_LIMIT")
		if err != nil {
			return err
		}
		if !hasLimit {
	...
	fn14 := func(t []*electra.PendingPartialWithdrawal) (err error) { // []*electra.PendingPartialWithdrawal:134217728:PENDING_PARTIAL_WITHDRAWALS_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("PENDING_PARTIAL_WITHDRAWALS_LIMIT")
		if err != nil {
			return err
		}
		if !hasLimit {
	...
	fn15 := func(t []*electra.PendingConsolidation) (err error) { // []*electra.PendingConsolidation:262144:PENDING_CONSOLIDATIONS_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("PENDING_CONSOLIDATIONS_LIMIT")
		if err != nil {
			return err
		}
		if !hasLimit {
	...
	fn16 := func(t []phase0.ValidatorIndex) (err error) { // []phase0.ValidatorIndex:64:(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH
		hasLimit, limit, err := ds.ResolveSpecValue("(MIN_SEED_LOOKAHEAD+1)*SLOTS_PER_EPOCH")
		if err != nil {
			return err
		}
