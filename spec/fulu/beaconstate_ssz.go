...
// Hash: 8df743e2e21dcf88a579f489a6aff25990b0cb74a2813282e5d64adf9ceabe9a
// Version: 0.1.3
package fulu
...
func (b *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(b.ProposerLookahead); size > 64 {
		err = ssz.ErrListTooBigFn("BeaconState.ProposerLookahead", size, 64)
		return
	}
...
func (b *BeaconState) UnmarshalSSZ(buf []byte) error {
	...
	// Field (37) 'ProposerLookahead'
	{
		...
		b.ProposerLookahead = make([]phase0.ValidatorIndex, num)
		for ii := 0; ii < num; ii++ {
			b.ProposerLookahead[ii] = phase0.ValidatorIndex(ssz.UnmarshallUint64(buf[ii*8 : (ii+1)*8]))
		}
	}
	return err
}
