...
// Hash: a84885c44c0d851b170e31ec88c0f5f503b28ef7f82a393871d643c57ec1f463
...
func (t *SignedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BeaconBlock) (err error) { // *bellatrix.BeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *SignedBeaconBlock) (err error) { // *bellatrix.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
