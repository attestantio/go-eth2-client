...
func (t *SignedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn16 := func(t *ExecutionPayload) (err error) { // *bellatrix.ExecutionPayload
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn17 := func(t *BeaconBlockBody) (err error) { // *bellatrix.BeaconBlockBody
		dstlen := len(dst)
	...
	fn18 := func(t *BeaconBlock) (err error) { // *bellatrix.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
	...
	fn19 := func(t *SignedBeaconBlock) (err error) { // *bellatrix.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn13 := func(t *BeaconBlockBody) (size int) { // *BeaconBlockBody
		size = 200
	...
	sfn14 := func(t *BeaconBlock) (size int) { // *BeaconBlock
		size = 80
		size += 4 + sfn13(t.Body)
		return size
	}
	sfn15 := func(t *SignedBeaconBlock) (size int) { // *SignedBeaconBlock
		size = 96
...
func (t *SignedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn17 := func(t *BeaconBlockBody, buf []byte) (*BeaconBlockBody, error) { // *BeaconBlockBody
		var err error
		if t == nil {
	...
	fn18 := func(t *BeaconBlock, buf []byte) (*BeaconBlock, error) { // *BeaconBlock
		var err error
		if t == nil {
			t = new(BeaconBlock)
		}
	...
	fn19 := func(t *SignedBeaconBlock, buf []byte) (*SignedBeaconBlock, error) { // *SignedBeaconBlock
		var err error
		if t == nil {
...
func (t *SignedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn13 := func(t Transaction) (err error) { // bellatrix.Transaction:1073741824:pack
		maxLen := 1073741824
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn14 := func(t []Transaction) (err error) { // []bellatrix.Transaction:1048576
		maxLen := 1048576
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn15 := func(t *ExecutionPayload) (err error) { // *bellatrix.ExecutionPayload
		idx := hh.Index()
		// Field #0 'ParentHash'
	...
	fn16 := func(t *BeaconBlockBody) (err error) { // *bellatrix.BeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
	...
	fn17 := func(t *BeaconBlock) (err error) { // *bellatrix.BeaconBlock
		idx := hh.Index()
		// Field #0 'Slot'
	...
	fn18 := func(t *SignedBeaconBlock) (err error) { // *bellatrix.SignedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
