...
// Hash: b19bda6c5cef91c7a5044ee4b1d6510973a4510868f705f985bb6eb2827cda9f
...
func (t *BeaconBlockBody) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn13 := func(t *ExecutionPayload) (err error) { // *bellatrix.ExecutionPayload
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn14 := func(t *BeaconBlockBody) (err error) { // *bellatrix.BeaconBlockBody
		dstlen := len(dst)
...
func (t *BeaconBlockBody) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn11 := func(t *BeaconBlockBody) (size int) { // *BeaconBlockBody
		size = 200
...
func (t *BeaconBlockBody) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn12 := func(t *ExecutionPayload) (err error) { // *bellatrix.ExecutionPayload
		err = t.HashTreeRootWithDyn(ds, hh)
		return err
	}
	fn13 := func(t *BeaconBlockBody) (err error) { // *bellatrix.BeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
