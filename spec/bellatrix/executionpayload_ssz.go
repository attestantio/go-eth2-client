...
// Hash: 3ed2d1a0e0c7b26d57be13fc01b9ce198ab6524403f3b30a841e58511efd041b
...
func (t *ExecutionPayload) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn2 := func(t Transaction) (err error) { // bellatrix.Transaction:1073741824:pack
		maxLen := 1073741824
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn3 := func(t []Transaction) (err error) { // []bellatrix.Transaction:1048576
		maxLen := 1048576
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
