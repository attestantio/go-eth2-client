...
// Hash: c6e3d6868e347f0e8992696a4a84de3b7f1c3fdafb2ce6497622ad46784bc4ca
...
func (t *BeaconState) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn16 := func(t *ExecutionPayloadHeader) (err error) { // *bellatrix.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn17 := func(t *BeaconState) (err error) { // *bellatrix.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn12 := func(t *ExecutionPayloadHeader) (err error) { // *bellatrix.ExecutionPayloadHeader
		var root [32]byte
	...
	fn13 := func(t *BeaconState) (err error) { // *bellatrix.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
