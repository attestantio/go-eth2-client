...
// Hash: 42bfaeaa4ac6c390d04ec8ac9bfa6530ca7d7f76ab105712d51ad5066ca8dee2
...
func (t *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn17 := func(t *ExecutionPayloadHeader) (err error) { // *bellatrix.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn18 := func(t *BeaconState) (err error) { // *bellatrix.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn18 := func(t *BeaconState, buf []byte) (*BeaconState, error) { // *BeaconState
		var err error
		if t == nil {
			t = new(BeaconState)
		}
...
func (t *BeaconState) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn12 := func(t *BeaconState) (err error) { // *bellatrix.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
