...
// Hash: f6ebf7a86aa3f1179b2380f28b3fd4b75606d91bf26556a15094ad2fae426c4a
...
func (t *BeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BeaconBlockBody) (err error) { // *capella.BeaconBlockBody
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *BeaconBlock) (err error) { // *capella.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
