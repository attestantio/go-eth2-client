...
// Hash: 3cd592b2cf1528876851f2f5d2388cb3e15e23abb98b48fc6cd93adb38b691dd
...
func (t *ExecutionPayload) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn2 := func(t bellatrix.Transaction) (err error) { // bellatrix.Transaction:1073741824:pack
		maxLen := 1073741824
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn3 := func(t []bellatrix.Transaction) (err error) { // []bellatrix.Transaction:1048576
		maxLen := 1048576
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn4 := func(t []*Withdrawal) (err error) { // []*capella.Withdrawal:16
		maxLen := 16
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn5 := func(t *ExecutionPayload) (err error) { // *capella.ExecutionPayload
		idx := hh.Index()
		// Field #0 'ParentHash'
