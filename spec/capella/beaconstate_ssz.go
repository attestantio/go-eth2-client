...
// Hash: a6ffab3ff6d4050944d71c1093ecf654c71c4c2f034cb836d3e7391835d68e0d
...
func (t *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn17 := func(t *ExecutionPayloadHeader) (err error) { // *capella.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn18 := func(t *HistoricalSummary) (err error) { // *capella.HistoricalSummary
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn19 := func(t []*HistoricalSummary) (err error) { // []*capella.HistoricalSummary
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn20 := func(t *BeaconState) (err error) { // *capella.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) SizeSSZ() (size int) {
	...
	sfn12 := func(t *ExecutionPayloadHeader) (size int) { // *ExecutionPayloadHeader
		size = t.SizeSSZ()
		return size
	}
	sfn13 := func(t []*HistoricalSummary) (size int) { // []*HistoricalSummary
		size += len(t) * 64
		return size
	}
	sfn14 := func(t *BeaconState) (size int) { // *BeaconState
		size = 393
...
func (t *BeaconState) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn17 := func(t *ExecutionPayloadHeader, buf []byte) (*ExecutionPayloadHeader, error) { // *ExecutionPayloadHeader
		var err error
		if t == nil {
	...
	fn18 := func(t *HistoricalSummary, buf []byte) (*HistoricalSummary, error) { // *HistoricalSummary
		var err error
		if t == nil {
	...
	fn19 := func(t []*HistoricalSummary, buf []byte) ([]*HistoricalSummary, error) { // []*HistoricalSummary
		var err error
		buflen := len(buf)
		itemsize := 64
		itemCount := buflen / itemsize
		...
		if len(t) < itemCount {
			t = make([]*HistoricalSummary, itemCount)
		} else {
			t = t[:itemCount]
		}
		for i := 0; i < itemCount; i++ {
	...
	fn20 := func(t *BeaconState, buf []byte) (*BeaconState, error) { // *BeaconState
		var err error
		if t == nil {
			t = new(BeaconState)
		}
		...
		// Field #25 'NextWithdrawalIndex'
		t.NextWithdrawalIndex = (WithdrawalIndex)(sszutils.UnmarshallUint64(buf[2736633:2736641]))
		// Field #26 'NextWithdrawalValidatorIndex'
...
func (t *BeaconState) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn12 := func(t []*HistoricalSummary) (err error) { // []*capella.HistoricalSummary:16777216
		maxLen := 16777216
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn13 := func(t *BeaconState) (err error) { // *capella.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
