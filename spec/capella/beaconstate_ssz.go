...
// Hash: c27ba0d186a8cdb149db10a3d3d1e4b5abc056b5ac3aead0e672ae5f9de7bd77
...
func (t *BeaconState) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn16 := func(t *ExecutionPayloadHeader) (err error) { // *capella.ExecutionPayloadHeader
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn17 := func(t *HistoricalSummary) (err error) { // *capella.HistoricalSummary
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn19 := func(t *BeaconState) (err error) { // *capella.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn12 := func(t []*HistoricalSummary) (size int) { // []*HistoricalSummary
		size += len(t) * 64
		return size
	}
...
func (t *BeaconState) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	fn17 := func(t *HistoricalSummary, buf []byte) (*HistoricalSummary, error) { // *HistoricalSummary
		var err error
		if t == nil {
	...
	fn19 := func(t *BeaconState, buf []byte) (*BeaconState, error) { // *BeaconState
		...
		{
			fieldsize := 8
			t.NextWithdrawalIndex = (WithdrawalIndex)(sszutils.UnmarshallUint64(buf[bufpos : bufpos+fieldsize]))
			bufpos += fieldsize
		}
		// Field #26 'NextWithdrawalValidatorIndex'
		{
...
func (t *BeaconState) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn12 := func(t *ExecutionPayloadHeader) (err error) { // *capella.ExecutionPayloadHeader
		var root [32]byte
	...
	fn13 := func(t *HistoricalSummary) (err error) { // *capella.HistoricalSummary:pack
		var root [32]byte
		if root, err = t.HashTreeRoot(); err == nil {
			hh.Append(root[:])
		}
	...
	fn14 := func(t []*HistoricalSummary) (err error) { // []*capella.HistoricalSummary:16777216:HISTORICAL_ROOTS_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("HISTORICAL_ROOTS_LIMIT")
		if err != nil {
			return err
		}
	...
	fn15 := func(t *BeaconState) (err error) { // *capella.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
		...
		if err = fn14(t.HistoricalSummaries); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
