...
func (t *SignedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn16 := func(t *ExecutionPayload) (err error) { // *capella.ExecutionPayload
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn17 := func(t *SignedBLSToExecutionChange) (err error) { // *capella.SignedBLSToExecutionChange
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn18 := func(t []*SignedBLSToExecutionChange) (err error) { // []*capella.SignedBLSToExecutionChange
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn19 := func(t *BeaconBlockBody) (err error) { // *capella.BeaconBlockBody
		dstlen := len(dst)
	...
	fn20 := func(t *BeaconBlock) (err error) { // *capella.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
	...
	fn21 := func(t *SignedBeaconBlock) (err error) { // *capella.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn13 := func(t []*SignedBLSToExecutionChange) (size int) { // []*SignedBLSToExecutionChange
		size += len(t) * 172
		return size
	}
	sfn14 := func(t *BeaconBlockBody) (size int) { // *BeaconBlockBody
		size = 200
	...
	sfn15 := func(t *BeaconBlock) (size int) { // *BeaconBlock
		size = 80
		size += 4 + sfn14(t.Body)
		return size
	}
	sfn16 := func(t *SignedBeaconBlock) (size int) { // *SignedBeaconBlock
		size = 96
		size += 4 + sfn15(t.Message)
		return size
	}
	return sfn16(t)
}
...
func (t *SignedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn17 := func(t *SignedBLSToExecutionChange, buf []byte) (*SignedBLSToExecutionChange, error) { // *SignedBLSToExecutionChange
		var err error
		if t == nil {
	...
	fn18 := func(t []*SignedBLSToExecutionChange, buf []byte) ([]*SignedBLSToExecutionChange, error) { // []*SignedBLSToExecutionChange
		var err error
		buflen := len(buf)
		itemsize := 172
		itemCount := buflen / itemsize
	...
	fn19 := func(t *BeaconBlockBody, buf []byte) (*BeaconBlockBody, error) { // *BeaconBlockBody
		var err error
		if t == nil {
	...
	fn20 := func(t *BeaconBlock, buf []byte) (*BeaconBlock, error) { // *BeaconBlock
		var err error
		if t == nil {
			t = new(BeaconBlock)
		}
	...
	fn21 := func(t *SignedBeaconBlock, buf []byte) (*SignedBeaconBlock, error) { // *SignedBeaconBlock
		var err error
		if t == nil {
...
func (t *SignedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn13 := func(t bellatrix.Transaction) (err error) { // bellatrix.Transaction:1073741824:pack
		maxLen := 1073741824
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn14 := func(t []bellatrix.Transaction) (err error) { // []bellatrix.Transaction:1048576
		maxLen := 1048576
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn15 := func(t []*Withdrawal) (err error) { // []*capella.Withdrawal:16
		maxLen := 16
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn16 := func(t *ExecutionPayload) (err error) { // *capella.ExecutionPayload
		...
		if err = fn14(t.Transactions); err != nil {
			return err
		}
		// Field #14 'Withdrawals'
		if err = fn15(t.Withdrawals); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
	}
	fn17 := func(t []*SignedBLSToExecutionChange) (err error) { // []*capella.SignedBLSToExecutionChange:16
		maxLen := 16
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn18 := func(t *BeaconBlockBody) (err error) { // *capella.BeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
	...
	fn19 := func(t *BeaconBlock) (err error) { // *capella.BeaconBlock
		idx := hh.Index()
		// Field #0 'Slot'
	...
	fn20 := func(t *SignedBeaconBlock) (err error) { // *capella.SignedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
		if err = fn19(t.Message); err != nil {
			return err
		}
		// Field #1 'Signature'
		hh.PutBytes(t.Signature[:])
