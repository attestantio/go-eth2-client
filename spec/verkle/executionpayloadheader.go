...
type ExecutionPayloadHeader struct {
	...
	ExecutionWitnessRoot phase0.Root   `ssz-size:"32"`
}
...
type executionPayloadHeaderJSON struct {
	...
	ExecutionWitnessRoot string `json:"execution_witness_root"`
}
...
type executionPayloadHeaderYAML struct {
	...
	ExecutionWitnessRoot string `yaml:"execution_witness_root"`
}
...
func (e *ExecutionPayloadHeader) MarshalJSON() ([]byte, error) {
	...
	return json.Marshal(&executionPayloadHeaderJSON{
		...
		ExecutionWitnessRoot: fmt.Sprintf("%032x", e.ExecutionWitnessRoot),
	})
}
