...
type VersionedSignedAggregateAndProof struct {
	...
	EIP7928   *electra.SignedAggregateAndProof
}
...
func (v *VersionedSignedAggregateAndProof) AggregatorIndex() (phase0.ValidatorIndex, error) {
	...
	case DataVersionEIP7928:
		if v.EIP7928 == nil {
			return 0, errors.New("no eip7928 signed aggregate and proof")
		}

		return v.EIP7928.Message.AggregatorIndex, nil
	default:
...
func (v *VersionedSignedAggregateAndProof) IsEmpty() bool {
	return v.Phase0 == nil && v.Altair == nil && v.Bellatrix == nil && v.Capella == nil && v.Deneb == nil &&
		v.Electra == nil && v.Fulu == nil && v.EIP7928 == nil
}
...
func (v *VersionedSignedAggregateAndProof) SelectionProof() (phase0.BLSSignature, error) {
	...
	case DataVersionEIP7928:
		if v.EIP7928 == nil {
			return phase0.BLSSignature{}, errors.New("no eip7928 signed aggregate and proof")
		}

		return v.EIP7928.Message.SelectionProof, nil
	default:
...
func (v *VersionedSignedAggregateAndProof) Slot() (phase0.Slot, error) {
	...
	case DataVersionEIP7928:
		...
		return v.EIP7928.Message.Aggregate.Data.Slot, nil
	default:
