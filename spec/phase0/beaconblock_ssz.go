...
// Hash: 15b8463e409ab314b0d1fe5c8ef2901ea2da87670fd9355a8f1d8c5dc5546785
...
func (t *BeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BeaconBlockBody) (err error) { // *phase0.BeaconBlockBody
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *BeaconBlock) (err error) { // *phase0.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
