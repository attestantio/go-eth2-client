...
// Hash: bbbb4e7e6861149c0e4bfc746c95a044124844291f9614c566c55908d1846e2d
...
func (t *SignedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BeaconBlock) (err error) { // *phase0.BeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *SignedBeaconBlock) (err error) { // *phase0.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
