...
// Hash: 6a9150e02a1f7abb7cd65811c1858a7b004b2d37b059c730e443bc7d776d4ee7
...
func (t *SignedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn16 := func(t *SignedBeaconBlock) (err error) { // *phase0.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn12 := func(t *SignedBeaconBlock) (size int) { // *SignedBeaconBlock
		size = 96
		size += 4 + sfn11(t.Message)
		return size
	}
	return sfn12(t)
}
...
func (t *SignedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn16 := func(t *SignedBeaconBlock, buf []byte) (*SignedBeaconBlock, error) { // *SignedBeaconBlock
		var err error
		if t == nil {
		...
		}
		{
			...
			if t.Message, err = fn15(t.Message, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
...
func (t *SignedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn12 := func(t *SignedBeaconBlock) (err error) { // *phase0.SignedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
		if err = fn11(t.Message); err != nil {
			return err
		}
		// Field #1 'Signature'
		hh.PutBytes(t.Signature[:])
