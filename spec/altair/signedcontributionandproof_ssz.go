...
func (t *SignedContributionAndProof) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn4 := func(t *SignedContributionAndProof) (err error) { // *altair.SignedContributionAndProof
		// Field #0 'Message'
...
func (t *SignedContributionAndProof) SizeSSZ() (size int) {
	...
	sfn4 := func(t *SignedContributionAndProof) (size int) { // *SignedContributionAndProof
		size = 96
		size += sfn3(t.Message)
		return size
	}
...
func (t *SignedContributionAndProof) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn4 := func(t *SignedContributionAndProof, buf []byte) (*SignedContributionAndProof, error) { // *SignedContributionAndProof
		var err error
		if t == nil {
		...
		// Field #0 'Message'
		if t.Message, err = fn3(t.Message, buf[0:264]); err != nil {
			return t, err
		}
		// Field #1 'Signature'
		copy(t.Signature[:], buf[264:360])
		return t, err
	}
	_, err = fn4(t, buf)
	return err
