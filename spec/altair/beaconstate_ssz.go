...
func (t *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn12 := func(t []ParticipationFlags) (err error) { // []altair.ParticipationFlags
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn16 := func(t *SyncCommittee) (err error) { // *altair.SyncCommittee
		// Field #0 'Pubkeys'
	...
	fn17 := func(t *BeaconState) (err error) { // *altair.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) SizeSSZ() (size int) {
	...
	sfn8 := func(t []ParticipationFlags) (size int) { // []ParticipationFlags
		size += len(t) * 1
		return size
	}
	...
	sfn11 := func(t *SyncCommittee) (size int) { // *SyncCommittee
		size = 48
		size += sfn10(t.Pubkeys)
		return size
	}
	sfn12 := func(t *BeaconState) (size int) { // *BeaconState
		size = 377
...
func (t *BeaconState) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn12 := func(t []ParticipationFlags, buf []byte) ([]ParticipationFlags, error) { // []ParticipationFlags
		var err error
		buflen := len(buf)
		itemsize := 1
		itemCount := buflen / itemsize
		...
		if len(t) < itemCount {
			t = make([]ParticipationFlags, itemCount)
		} else {
			t = t[:itemCount]
		}
		for i := 0; i < itemCount; i++ {
			t[i] = (ParticipationFlags)(sszutils.UnmarshallUint8(buf[i*itemsize : (i+1)*itemsize]))
		}
		return t, err
	}
	...
	fn16 := func(t *SyncCommittee, buf []byte) (*SyncCommittee, error) { // *SyncCommittee
		var err error
		if t == nil {
			t = new(SyncCommittee)
		}
	...
	fn17 := func(t *BeaconState, buf []byte) (*BeaconState, error) { // *BeaconState
		var err error
		if t == nil {
			t = new(BeaconState)
		}
...
func (t *BeaconState) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn8 := func(t []ParticipationFlags) (err error) { // []altair.ParticipationFlags:1099511627776
		maxLen := 1099511627776
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn11 := func(t *SyncCommittee) (err error) { // *altair.SyncCommittee
		idx := hh.Index()
		// Field #0 'Pubkeys'
	...
	fn12 := func(t *BeaconState) (err error) { // *altair.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
