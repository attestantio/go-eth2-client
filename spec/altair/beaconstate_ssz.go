...
// Hash: 790645311437d3c8c8907f07b5812a92cecd89988ee91b4566fe41c30c9e136d
...
func (t *BeaconState) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn15 := func(t *SyncCommittee) (err error) { // *altair.SyncCommittee
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn16 := func(t *BeaconState) (err error) { // *altair.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn10 := func(t *SyncCommittee) (size int) { // *SyncCommittee
		size = t.SizeSSZDyn(ds)
		return size
	}
	sfn11 := func(t *BeaconState) (size int) { // *BeaconState
		size = 377
...
func (t *BeaconState) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	sfn5 := func() (size int) { // *SyncCommittee
		size = 48
		size += sfn4
		return size
	}()
	...
	fn15 := func(t *SyncCommittee, buf []byte) (*SyncCommittee, error) { // *SyncCommittee
		var err error
		if t == nil {
			t = new(SyncCommittee)
		}
	...
	fn16 := func(t *BeaconState, buf []byte) (*BeaconState, error) { // *BeaconState
		var err error
		if t == nil {
			t = new(BeaconState)
		}
...
func (t *BeaconState) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn8 := func(t []ParticipationFlags) (err error) { // []altair.ParticipationFlags:1099511627776:VALIDATOR_REGISTRY_LIMIT
		hasLimit, maxLen, err := ds.ResolveSpecValue("VALIDATOR_REGISTRY_LIMIT")
		if err != nil {
			return err
		}
	...
	fn10 := func(t *SyncCommittee) (err error) { // *altair.SyncCommittee
		err = t.HashTreeRootWithDyn(ds, hh)
		return err
	}
	fn11 := func(t *BeaconState) (err error) { // *altair.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
		...
		// Field #22 'CurrentSyncCommittee'
		if err = fn10(t.CurrentSyncCommittee); err != nil {
			return err
		}
		// Field #23 'NextSyncCommittee'
		if err = fn10(t.NextSyncCommittee); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
