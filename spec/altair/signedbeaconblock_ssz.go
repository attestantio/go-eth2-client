...
// Hash: 3116d10387d2f32e54029bdef056778553e9b7c2199495a5499ba7278ab5c49c
...
func (t *SignedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn17 := func(t *BeaconBlock) (err error) { // *altair.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
	...
	fn18 := func(t *SignedBeaconBlock) (err error) { // *altair.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn13 := func(t *BeaconBlock) (size int) { // *BeaconBlock
		size = 80
		size += 4 + sfn12(t.Body)
		return size
	}
	sfn14 := func(t *SignedBeaconBlock) (size int) { // *SignedBeaconBlock
		size = 96
		size += 4 + sfn13(t.Message)
		return size
	}
	return sfn14(t)
}
...
func (t *SignedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn17 := func(t *BeaconBlock, buf []byte) (*BeaconBlock, error) { // *BeaconBlock
		var err error
		if t == nil {
			t = new(BeaconBlock)
		}
		...
		}
		{
			...
			if t.Body, err = fn16(t.Body, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
	...
	fn18 := func(t *SignedBeaconBlock, buf []byte) (*SignedBeaconBlock, error) { // *SignedBeaconBlock
		var err error
		if t == nil {
		...
		}
		{
			...
			if t.Message, err = fn17(t.Message, fieldSlice); err != nil {
				return t, err
			}
			bufpos += len(fieldSlice)
		}
...
func (t *SignedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn13 := func(t *BeaconBlock) (err error) { // *altair.BeaconBlock
		idx := hh.Index()
		// Field #0 'Slot'
	...
	fn14 := func(t *SignedBeaconBlock) (err error) { // *altair.SignedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
