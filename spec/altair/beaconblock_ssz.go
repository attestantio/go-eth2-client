...
// Hash: d1b40d577c0f11df7d4aa017caea0851c89142d7a9b0752f28795627eec4ddd8
...
func (t *BeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BeaconBlockBody) (err error) { // *altair.BeaconBlockBody
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *BeaconBlock) (err error) { // *altair.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
