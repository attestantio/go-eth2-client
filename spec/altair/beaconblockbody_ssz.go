...
// Hash: 78441761bbdc7d7fb8b3034bc901576494a07b238a8c850b353d7d5ba3a73215
...
func (t *BeaconBlockBody) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn12 := func(t *SyncAggregate) (err error) { // *altair.SyncAggregate
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn13 := func(t *BeaconBlockBody) (err error) { // *altair.BeaconBlockBody
		dstlen := len(dst)
...
func (t *BeaconBlockBody) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn9 := func(t *SyncAggregate) (size int) { // *SyncAggregate
		size = t.SizeSSZDyn(ds)
		return size
	}
...
func (t *BeaconBlockBody) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	sfn4 := func() (size int) { // *SyncAggregate
		size = 96
		size += sfn3
		return size
	}()
	...
	fn12 := func(t *SyncAggregate, buf []byte) (*SyncAggregate, error) { // *SyncAggregate
		var err error
		if t == nil {
			t = new(SyncAggregate)
		}
	...
	fn13 := func(t *BeaconBlockBody, buf []byte) (*BeaconBlockBody, error) { // *BeaconBlockBody
		var err error
		if t == nil {
...
func (t *BeaconBlockBody) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn10 := func(t *SyncAggregate) (err error) { // *altair.SyncAggregate
		err = t.HashTreeRootWithDyn(ds, hh)
		return err
	}
	fn11 := func(t *BeaconBlockBody) (err error) { // *altair.BeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
		...
		// Field #8 'SyncAggregate'
		if err = fn10(t.SyncAggregate); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
