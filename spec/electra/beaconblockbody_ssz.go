...
// Hash: abc172de189840e063a082cdaa577b81dd9d0cbd4eab57eba6c74a45f4a21d7d
...
func (t *BeaconBlockBody) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn4 := func(t *AttesterSlashing) (err error) { // *electra.AttesterSlashing
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn5 := func(t []*AttesterSlashing) (err error) { // []*electra.AttesterSlashing
		vlen := len(t)
		dstlen := len(dst)
	...
	fn6 := func(t *Attestation) (err error) { // *electra.Attestation
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn7 := func(t []*Attestation) (err error) { // []*electra.Attestation
		vlen := len(t)
		dstlen := len(dst)
		dst = sszutils.AppendZeroPadding(dst, vlen*4)
		for i := 0; i < vlen; i++ {
	...
	fn13 := func(t *deneb.ExecutionPayload) (err error) { // *deneb.ExecutionPayload
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn17 := func(t *ExecutionRequests) (err error) { // *electra.ExecutionRequests
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn18 := func(t *BeaconBlockBody) (err error) { // *electra.BeaconBlockBody
		dstlen := len(dst)
...
func (t *BeaconBlockBody) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn10 := func(t *deneb.ExecutionPayload) (size int) { // *deneb.ExecutionPayload
		size = t.SizeSSZ()
		return size
	}
	...
	sfn13 := func(t *ExecutionRequests) (size int) { // *ExecutionRequests
		size = t.SizeSSZ()
		return size
	}
...
func (t *BeaconBlockBody) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	fn13 := func(t *deneb.ExecutionPayload, buf []byte) (*deneb.ExecutionPayload, error) { // *deneb.ExecutionPayload
		var err error
		if t == nil {
	...
	fn17 := func(t *ExecutionRequests, buf []byte) (*ExecutionRequests, error) { // *ExecutionRequests
		var err error
		if t == nil {
	...
	fn18 := func(t *BeaconBlockBody, buf []byte) (*BeaconBlockBody, error) { // *BeaconBlockBody
		var err error
		if t == nil {
...
func (t *BeaconBlockBody) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn2 := func(t *AttesterSlashing) (err error) { // *electra.AttesterSlashing:pack
		err = t.HashTreeRootWithDyn(ds, hh)
		return err
	}
	fn3 := func(t []*AttesterSlashing) (err error) { // []*electra.AttesterSlashing:1:MAX_ATTESTER_SLASHINGS_ELECTRA
	...
	fn4 := func(t *Attestation) (err error) { // *electra.Attestation:pack
		err = t.HashTreeRootWithDyn(ds, hh)
		return err
	}
	fn5 := func(t []*Attestation) (err error) { // []*electra.Attestation:8:MAX_ATTESTATIONS_ELECTRA
	...
	fn20 := func(t *ExecutionRequests) (err error) { // *electra.ExecutionRequests
		err = t.HashTreeRootWithDyn(ds, hh)
		return err
	}
	fn21 := func(t *BeaconBlockBody) (err error) { // *electra.BeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
		...
		if err = fn3(t.AttesterSlashings); err != nil {
			return err
		}
		...
		if err = fn20(t.ExecutionRequests); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
