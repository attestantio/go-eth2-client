...
// Hash: 21176cebc08a0e165b1ecb11367b7f219da37452d87e927175d034750fa826ca
...
func (t *AttesterSlashing) HashTreeRootWith(hh sszutils.HashWalker) error {
	fn1 := func(t []uint64) (err error) { // []uint64:131072
		maxLen := 131072
		vlen := len(t)
		if vlen > int(maxLen) {
	...
	fn3 := func(t *AttesterSlashing) (err error) { // *electra.AttesterSlashing
		idx := hh.Index()
		// Field #0 'Attestation1'
		if err = fn2(t.Attestation1); err != nil {
			return err
		}
		// Field #1 'Attestation2'
		if err = fn2(t.Attestation2); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
