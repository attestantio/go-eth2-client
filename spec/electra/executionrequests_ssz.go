...
// Hash: 17e18ef210e60813f0827b83e7c77148a8cd36359f460d2f6e2b1e4902abbaae
...
func (t *ExecutionRequests) MarshalSSZDyn(_ sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
...
func (t *ExecutionRequests) UnmarshalSSZDyn(_ sszutils.DynamicSpecs, buf []byte) (err error) {
...
func (t *ExecutionRequests) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	fn1 := func(t *DepositRequest) (err error) { // *electra.DepositRequest:pack
		var root [32]byte
	...
	fn2 := func(t []*DepositRequest) (err error) { // []*electra.DepositRequest:8192:MAX_DEPOSIT_REQUESTS_PER_PAYLOAD
	...
	fn3 := func(t *WithdrawalRequest) (err error) { // *electra.WithdrawalRequest:pack
		var root [32]byte
		if root, err = t.HashTreeRoot(); err == nil {
			hh.Append(root[:])
		}
	...
	fn4 := func(t []*WithdrawalRequest) (err error) { // []*electra.WithdrawalRequest:16:MAX_WITHDRAWAL_REQUESTS_PER_PAYLOAD
	...
	fn5 := func(t *ConsolidationRequest) (err error) { // *electra.ConsolidationRequest:pack
		var root [32]byte
		if root, err = t.HashTreeRoot(); err == nil {
			hh.Append(root[:])
		}
	...
	fn6 := func(t []*ConsolidationRequest) (err error) { // []*electra.ConsolidationRequest:2:MAX_CONSOLIDATION_REQUESTS_PER_PAYLOAD
...
func (t *ExecutionRequests) HashTreeRootDyn(ds sszutils.DynamicSpecs) ([32]byte, error) {
