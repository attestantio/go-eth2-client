...
// Hash: 3897e4d59aaf13837c5aff54e73869368479c434f5f94c3a7ab298aa8a8d2746
...
func (t *BeaconState) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	...
	fn19 := func(t *PendingDeposit) (err error) { // *electra.PendingDeposit
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn21 := func(t *PendingPartialWithdrawal) (err error) { // *electra.PendingPartialWithdrawal
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn23 := func(t *PendingConsolidation) (err error) { // *electra.PendingConsolidation
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	...
	fn25 := func(t *BeaconState) (err error) { // *electra.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
	...
	sfn13 := func(t []*PendingDeposit) (size int) { // []*PendingDeposit
		size += len(t) * 192
		return size
	}
	sfn14 := func(t []*PendingPartialWithdrawal) (size int) { // []*PendingPartialWithdrawal
		size += len(t) * 24
		return size
	}
	sfn15 := func(t []*PendingConsolidation) (size int) { // []*PendingConsolidation
		size += len(t) * 16
		return size
	}
	sfn16 := func(t *BeaconState) (size int) { // *BeaconState
		size = 441
...
func (t *BeaconState) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
	...
	fn19 := func(t *PendingDeposit, buf []byte) (*PendingDeposit, error) { // *PendingDeposit
		var err error
		if t == nil {
	...
	fn21 := func(t *PendingPartialWithdrawal, buf []byte) (*PendingPartialWithdrawal, error) { // *PendingPartialWithdrawal
		var err error
		if t == nil {
	...
	fn23 := func(t *PendingConsolidation, buf []byte) (*PendingConsolidation, error) { // *PendingConsolidation
		var err error
		if t == nil {
	...
	fn25 := func(t *BeaconState, buf []byte) (*BeaconState, error) { // *BeaconState
		var err error
		if t == nil {
			t = new(BeaconState)
		}
...
func (t *BeaconState) HashTreeRootWithDyn(ds sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
	...
	fn13 := func(t *PendingDeposit) (err error) { // *electra.PendingDeposit:pack
		var root [32]byte
	...
	fn14 := func(t []*PendingDeposit) (err error) { // []*electra.PendingDeposit:134217728:PENDING_DEPOSITS_LIMIT
	...
	fn15 := func(t *PendingPartialWithdrawal) (err error) { // *electra.PendingPartialWithdrawal:pack
		var root [32]byte
		if root, err = t.HashTreeRoot(); err == nil {
			hh.Append(root[:])
		}
	...
	fn16 := func(t []*PendingPartialWithdrawal) (err error) { // []*electra.PendingPartialWithdrawal:134217728:PENDING_PARTIAL_WITHDRAWALS_LIMIT
	...
	fn17 := func(t *PendingConsolidation) (err error) { // *electra.PendingConsolidation:pack
		var root [32]byte
		if root, err = t.HashTreeRoot(); err == nil {
			hh.Append(root[:])
		}
	...
	fn18 := func(t []*PendingConsolidation) (err error) { // []*electra.PendingConsolidation:262144:PENDING_CONSOLIDATIONS_LIMIT
	...
	fn19 := func(t *BeaconState) (err error) { // *electra.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
		...
		if err = fn14(t.PendingDeposits); err != nil {
			return err
		}
		// Field #35 'PendingPartialWithdrawals'
		if err = fn16(t.PendingPartialWithdrawals); err != nil {
			return err
		}
		// Field #36 'PendingConsolidations'
		if err = fn18(t.PendingConsolidations); err != nil {
			return err
		}
		hh.Merkleize(idx)
		return err
