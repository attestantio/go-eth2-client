...
func (t *BeaconState) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn20 := func(t *PendingDeposit) (err error) { // *electra.PendingDeposit
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn21 := func(t []*PendingDeposit) (err error) { // []*electra.PendingDeposit
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn22 := func(t *PendingPartialWithdrawal) (err error) { // *electra.PendingPartialWithdrawal
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn23 := func(t []*PendingPartialWithdrawal) (err error) { // []*electra.PendingPartialWithdrawal
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn24 := func(t *PendingConsolidation) (err error) { // *electra.PendingConsolidation
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn25 := func(t []*PendingConsolidation) (err error) { // []*electra.PendingConsolidation
		vlen := len(t)
		for i := 0; i < vlen; i++ {
	...
	fn26 := func(t *BeaconState) (err error) { // *electra.BeaconState
		dstlen := len(dst)
		// Field #0 'GenesisTime'
...
func (t *BeaconState) SizeSSZ() (size int) {
	...
	sfn14 := func(t []*PendingDeposit) (size int) { // []*PendingDeposit
		size += len(t) * 192
		return size
	}
	sfn15 := func(t []*PendingPartialWithdrawal) (size int) { // []*PendingPartialWithdrawal
		size += len(t) * 24
		return size
	}
	sfn16 := func(t []*PendingConsolidation) (size int) { // []*PendingConsolidation
		size += len(t) * 16
		return size
	}
	sfn17 := func(t *BeaconState) (size int) { // *BeaconState
		size = 441
...
func (t *BeaconState) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn20 := func(t *PendingDeposit, buf []byte) (*PendingDeposit, error) { // *PendingDeposit
		var err error
		if t == nil {
	...
	fn21 := func(t []*PendingDeposit, buf []byte) ([]*PendingDeposit, error) { // []*PendingDeposit
		var err error
		buflen := len(buf)
		itemsize := 192
		itemCount := buflen / itemsize
		...
		if len(t) < itemCount {
			t = make([]*PendingDeposit, itemCount)
		} else {
			t = t[:itemCount]
		}
		for i := 0; i < itemCount; i++ {
	...
	fn22 := func(t *PendingPartialWithdrawal, buf []byte) (*PendingPartialWithdrawal, error) { // *PendingPartialWithdrawal
		var err error
		if t == nil {
	...
	fn23 := func(t []*PendingPartialWithdrawal, buf []byte) ([]*PendingPartialWithdrawal, error) { // []*PendingPartialWithdrawal
		var err error
		buflen := len(buf)
		itemsize := 24
		itemCount := buflen / itemsize
		...
		if len(t) < itemCount {
			t = make([]*PendingPartialWithdrawal, itemCount)
		} else {
			t = t[:itemCount]
		}
		for i := 0; i < itemCount; i++ {
	...
	fn24 := func(t *PendingConsolidation, buf []byte) (*PendingConsolidation, error) { // *PendingConsolidation
		var err error
		if t == nil {
	...
	fn25 := func(t []*PendingConsolidation, buf []byte) ([]*PendingConsolidation, error) { // []*PendingConsolidation
		var err error
		buflen := len(buf)
		itemsize := 16
		itemCount := buflen / itemsize
		...
		if len(t) < itemCount {
			t = make([]*PendingConsolidation, itemCount)
		} else {
			t = t[:itemCount]
		}
		for i := 0; i < itemCount; i++ {
	...
	fn26 := func(t *BeaconState, buf []byte) (*BeaconState, error) { // *BeaconState
		var err error
		if t == nil {
			t = new(BeaconState)
		}
...
func (t *BeaconState) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn13 := func(t []*PendingDeposit) (err error) { // []*electra.PendingDeposit:134217728
		maxLen := 134217728
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn14 := func(t []*PendingPartialWithdrawal) (err error) { // []*electra.PendingPartialWithdrawal:134217728
		maxLen := 134217728
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn15 := func(t []*PendingConsolidation) (err error) { // []*electra.PendingConsolidation:262144
		maxLen := 262144
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn16 := func(t *BeaconState) (err error) { // *electra.BeaconState
		idx := hh.Index()
		// Field #0 'GenesisTime'
