...
// Hash: 7e87f478cbc7d8b97b0825afaab9d1e68cb493d86b3ab7918a33d06daa823dd1
...
func (t *SignedBeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BeaconBlock) (err error) { // *electra.BeaconBlock
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *SignedBeaconBlock) (err error) { // *electra.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
