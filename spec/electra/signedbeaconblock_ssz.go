...
// Hash: 891351c8f2b2ca66ce99781191039b0d66484b38f614f9e39fa8e5006474a0f0
...
func (t *SignedBeaconBlock) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	fn9 := func(t *Attestation) (err error) { // *electra.Attestation
		dstlen := len(dst)
	...
	fn10 := func(t []*Attestation) (err error) { // []*electra.Attestation
		vlen := len(t)
		dstlen := len(dst)
		dst = sszutils.AppendZeroPadding(dst, vlen*4)
		for i := 0; i < vlen; i++ {
	...
	fn23 := func(t *ExecutionRequests) (err error) { // *electra.ExecutionRequests
		dst, err = t.MarshalSSZTo(dst)
		return err
	}
	fn24 := func(t *BeaconBlockBody) (err error) { // *electra.BeaconBlockBody
		dstlen := len(dst)
	...
	fn25 := func(t *BeaconBlock) (err error) { // *electra.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
	...
	fn26 := func(t *SignedBeaconBlock) (err error) { // *electra.SignedBeaconBlock
		dstlen := len(dst)
		// Offset #0 'Message'
		offset0 := len(dst)
		dst = sszutils.MarshalOffset(dst, 0)
...
func (t *SignedBeaconBlock) SizeSSZ() (size int) {
	...
	sfn6 := func(t *Attestation) (size int) { // *Attestation
		size = 224
		size += 4 + sfn4(t.AggregationBits)
		size += sfn5(t.CommitteeBits)
		return size
	}
	sfn7 := func(t []*Attestation) (size int) { // []*Attestation
		vlen := len(t)
		for i := 0; i < vlen; i++ {
			size += 4 + sfn6(t[i])
		}
	...
	sfn17 := func(t *ExecutionRequests) (size int) { // *ExecutionRequests
		size = t.SizeSSZ()
		return size
	}
	sfn18 := func(t *BeaconBlockBody) (size int) { // *BeaconBlockBody
		size = 200
	...
	sfn19 := func(t *BeaconBlock) (size int) { // *BeaconBlock
		size = 80
		size += 4 + sfn18(t.Body)
		return size
	}
	sfn20 := func(t *SignedBeaconBlock) (size int) { // *SignedBeaconBlock
		size = 96
...
func (t *SignedBeaconBlock) UnmarshalSSZ(buf []byte) (err error) {
	...
	fn9 := func(t *Attestation, buf []byte) (*Attestation, error) { // *Attestation
		var err error
		if t == nil {
			t = new(Attestation)
		}
	...
	fn10 := func(t []*Attestation, buf []byte) ([]*Attestation, error) { // []*Attestation
		var err error
		buflen := len(buf)
		if buflen == 0 {
			return t, nil
	...
	fn23 := func(t *ExecutionRequests, buf []byte) (*ExecutionRequests, error) { // *ExecutionRequests
		var err error
		if t == nil {
	...
	fn24 := func(t *BeaconBlockBody, buf []byte) (*BeaconBlockBody, error) { // *BeaconBlockBody
		var err error
		if t == nil {
	...
	fn25 := func(t *BeaconBlock, buf []byte) (*BeaconBlock, error) { // *BeaconBlock
		var err error
		if t == nil {
			t = new(BeaconBlock)
		}
	...
	fn26 := func(t *SignedBeaconBlock, buf []byte) (*SignedBeaconBlock, error) { // *SignedBeaconBlock
		var err error
		if t == nil {
...
func (t *SignedBeaconBlock) HashTreeRootWith(hh sszutils.HashWalker) error {
	...
	fn4 := func(t *AttesterSlashing) (err error) { // *electra.AttesterSlashing:pack
		idx := hh.Index()
	...
	fn5 := func(t []*AttesterSlashing) (err error) { // []*electra.AttesterSlashing:1
		maxLen := 1
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn8 := func(t *Attestation) (err error) { // *electra.Attestation:pack
		idx := hh.Index()
	...
	fn9 := func(t []*Attestation) (err error) { // []*electra.Attestation:8
		maxLen := 8
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn24 := func(t []*DepositRequest) (err error) { // []*electra.DepositRequest:8192
		maxLen := 8192
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn25 := func(t []*WithdrawalRequest) (err error) { // []*electra.WithdrawalRequest:16
		maxLen := 16
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn26 := func(t []*ConsolidationRequest) (err error) { // []*electra.ConsolidationRequest:2
		maxLen := 2
		vlen := len(t)
		if vlen > int(maxLen) {
			return sszutils.ErrListTooBig
	...
	fn27 := func(t *ExecutionRequests) (err error) { // *electra.ExecutionRequests
		idx := hh.Index()
		// Field #0 'Deposits'
	...
	fn28 := func(t *BeaconBlockBody) (err error) { // *electra.BeaconBlockBody
		idx := hh.Index()
		// Field #0 'RANDAOReveal'
	...
	fn29 := func(t *BeaconBlock) (err error) { // *electra.BeaconBlock
		idx := hh.Index()
		// Field #0 'Slot'
	...
	fn30 := func(t *SignedBeaconBlock) (err error) { // *electra.SignedBeaconBlock
		idx := hh.Index()
		// Field #0 'Message'
