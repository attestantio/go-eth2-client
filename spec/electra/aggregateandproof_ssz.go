...
// Hash: 1347e89388e7e89030d90f0419367cde84425a7899b70dfac7657a0969e17c56
...
func (t *AggregateAndProof) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *Attestation) (err error) { // *electra.Attestation
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *AggregateAndProof) (err error) { // *electra.AggregateAndProof
		dstlen := len(dst)
...
func (t *AggregateAndProof) SizeSSZDyn(ds sszutils.DynamicSpecs) (size int) {
...
func (t *AggregateAndProof) UnmarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (err error) {
