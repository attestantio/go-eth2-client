...
// Hash: 5c3be555d772c911157c8a9ee0a9116c929eab9b73ef1a302faf996c01740abd
...
func (t *BeaconBlock) MarshalSSZDyn(ds sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
	dst = buf
	fn1 := func(t *BeaconBlockBody) (err error) { // *electra.BeaconBlockBody
		dst, err = t.MarshalSSZDyn(ds, dst)
		return err
	}
	fn2 := func(t *BeaconBlock) (err error) { // *electra.BeaconBlock
		dstlen := len(dst)
		// Field #0 'Slot'
