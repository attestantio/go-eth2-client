...
func (a *Attestation) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if size := len(a.CommitteeBits); size != 1 {
		err = ssz.ErrBytesLengthFn("Attestation.CommitteeBits", size, 1)
		return
	}
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	if cap(a.CommitteeBits) == 0 {
		a.CommitteeBits = make([]byte, 0, len(buf[132:133]))
	}
	a.CommitteeBits = append(a.CommitteeBits, buf[132:133]...)

	// Field (3) 'Signature'
	copy(a.Signature[:], buf[133:229])
