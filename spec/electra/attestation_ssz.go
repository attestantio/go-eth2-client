...
// Hash: 705104a536b16a7da183e694e9343314f84e5534018fb037f4f0dd0e1dfc35ff
// Version: 0.1.3
package electra
...
func (a *Attestation) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o0:]
		if err = ssz.ValidateBitlist(buf, 16385); err != nil {
			return err
		}
...
func (a *Attestation) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	hh.PutBitlist(a.AggregationBits, 16385)
