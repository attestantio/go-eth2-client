...
// Hash: 688d8e0f44be02f6efdd8e361b21e447e38c3c6bbd17e5570bcd2532bbd10deb
...
func (t *WithdrawalRequests) MarshalSSZDyn(_ sszutils.DynamicSpecs, buf []byte) (dst []byte, err error) {
...
func (t *WithdrawalRequests) SizeSSZDyn(_ sszutils.DynamicSpecs) (size int) {
	return t.SizeSSZ()
}
...
func (t *WithdrawalRequests) UnmarshalSSZDyn(_ sszutils.DynamicSpecs, buf []byte) (err error) {
...
func (t *WithdrawalRequests) HashTreeRootWithDyn(_ sszutils.DynamicSpecs, hh sszutils.HashWalker) error {
...
func (t *WithdrawalRequests) HashTreeRootDyn(ds sszutils.DynamicSpecs) ([32]byte, error) {
