...
// eventPayloads are the data of real events, by topic, so that decoding them tests the
// library's types against what nodes send rather than against their own marshalling.  The
// payloads of attestation, attester_slashing, block, bls_to_execution_change, chain_reorg,
// contribution_and_proof, finalized_checkpoint, head, proposer_slashing and voluntary_exit
// were captured from mainnet nodes.  The rest are verbatim from the examples in beacon-APIs
// apis/eventstream/index.yaml at master, except for:
//   - blob_sidecar, from v3.1.0, as the topic has since been removed;
//   - data_column_sidecar, from v4.0.0, and payload_attributes, from v3.1.0, as the later
//     examples are of shapes the library does not yet decode;
//   - the KZG commitments of blob_sidecar and data_column_sidecar, which the spec examples give
//     as 96 bytes, cut to the 48 bytes of a commitment.
var eventPayloads = map[string]string{
	"attestation":                 `{"aggregation_bits":"0x00002840403040000000020008800040008042800000020220","data":{"slot":"4095945","index":"12","beacon_block_root":"0xff27c7551bf4cfe4dc4cce00920e7a5c5074860d1dbd8aa8b3b5f888523f51ff","source":{"epoch":"127997","root":"0x38758fb180459583bd5e8e1a31711eb09e63eb92be974485397e9a2c57de2783"},"target":{"epoch":"127998","root":"0x46d4629861bd81cfc94007501b4edb1b3ca9444b41d7a98681b6c2f4bdb978bd"}},"signature":"0xacb9f562a28c4ef5b60b88678068ea51573a3237d3331dda3b2d845a0d03bc56ab2994d2deb90d9f074a8bdab59945150d0a7717e74b1bf2627f8971c81091f724c211dfce8fa16fb839c6a1bfd341ddec5e7eb88472682fd1a170e373660534"}`,
	...
	"blob_sidecar":                `{"block_root": "0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2", "index": "1", "slot": "1", "kzg_commitment": "0x1b66ac1fb663c9bc59509846d6ec05345bd908eda73e670af888da41af171505cc411d61252fb6cb3fa0017b679f8bb2", "versioned_hash": "0xcf8e0d4e9587369b2301d0790347320302cc0943d5a1884560367e8208d920f2"}`,
	"block":                       `{"slot":"4095943","block":"0x1c3981b7439cd2dc53dca1a99122e1cacb36a13796d426d4c8a03ba745cb0c8b","execution_optimistic":false}`,
	"block_gossip":                `{"slot":"10", "block":"0x9a2fefd2fdb57f74993c7780ea5b9030d2897b615b89f808011ca5aebed54eaf"}`,
	"bls_to_execution_change":     `{"message":{"validator_index":"63401","from_bls_pubkey":"0xa46ed2574770ec1942d577ef89e0bf7b0d601349dab791740dead3fb5a6e2624cf62b9e58de1074c49f44b986eb39002","to_execution_address":"0xd641D2Cc74C7b6A641861260d07D67eB67bc7403"},"signature":"0xb9ce6f10137a8bc73cd5545e5d6c7c61bc1294b853e71e5eb090a7a773d7773c4d7732f4244e9891cd5c1f7a5fbc951c0b368a8bd7dc44b1598a6d1bdb4476f9f364ef521c366e55565792810f0cb8bf8cc20134f32ed8dde54507f622402d6e"}`,
	"chain_reorg":                 `{"slot":"4100237","depth":"2","old_head_block":"0x5c988c12b7d8638c06e6b9511e09e5e28511a16a33c153413416d3fd5d95353a","new_head_block":"0x783ccb4310c0ddab3ea500f8d2b88c5ad8d6b2d601513f4ebf491066cda1d180","old_head_state":"0xdbad017808a1c5a77866fccc3e15f14a67585fff25b3a4d947ae9cc6d937b4ab","new_head_state":"0x67f0302bb939f64b1feaaa907b30c9631c0588480f2305578377bfd87df68b95","epoch":"128132","execution_optimistic":false}`,
...
func TestHandleEventDispatchesEverySupportedTopic(t *testing.T) {
	tests := []struct {
		...
		{topic: "attestation", expected: &spec.VersionedAttestation{}},
		{topic: "attester_slashing", expected: &electra.AttesterSlashing{}},
		{topic: "blob_sidecar", expected: &apiv1.BlobSidecarEvent{}},
		{topic: "block", expected: &apiv1.BlockEvent{}},
		{topic: "block_gossip", expected: &apiv1.BlockGossipEvent{}},
		{topic: "bls_to_execution_change", expected: &capella.SignedBLSToExecutionChange{}},
		{topic: "chain_reorg", expected: &apiv1.ChainReorgEvent{}},
		{topic: "contribution_and_proof", expected: &altair.SignedContributionAndProof{}},
		{topic: "data_column_sidecar", expected: &apiv1.DataColumnSidecarEvent{}},
		{topic: "execution_payload", expected: &apiv1.ExecutionPayloadEvent{}},
		{topic: "execution_payload_available", expected: &apiv1.ExecutionPayloadAvailableEvent{}},
		{topic: "execution_payload_bid", expected: &gloas.SignedExecutionPayloadBid{}},
		{topic: "execution_payload_gossip", expected: &apiv1.ExecutionPayloadGossipEvent{}},
		{topic: "fast_confirmation", expected: &apiv1.FastConfirmationEvent{}},
		{topic: "finalized_checkpoint", expected: &apiv1.FinalizedCheckpointEvent{}},
		{topic: "head", expected: &apiv1.HeadEvent{}},
		{topic: "payload_attestation_message", expected: &gloas.PayloadAttestationMessage{}},
		{topic: "payload_attributes", expected: &apiv1.PayloadAttributesEvent{}},
		{topic: "proposer_preferences", expected: &gloas.SignedProposerPreferences{}},
		{topic: "proposer_slashing", expected: &phase0.ProposerSlashing{}},
		{topic: "single_attestation", expected: &electra.SingleAttestation{}},
		{topic: "voluntary_exit", expected: &phase0.SignedVoluntaryExit{}},
	}
	...
	for _, test := range tests {
		t.Run(test.topic, func(t *testing.T) {
			...
			require.Contains(t, eventPayloads, test.topic, "no real payload for the topic")

			var event *apiv1.Event
			service := &Service{}
			service.handleEvent(context.Background(), &sse.Event{
				Event: []byte(test.topic),
				Data:  []byte(eventPayloads[test.topic]),
			}, &api.EventsOpts{
			...
			require.NotNil(t, event, "the payload was not decoded")
